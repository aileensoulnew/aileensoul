                                ...
                                if (count($article_list) != 0){
                                    ...
                                    foreach ($article_list as $article) {?>
                                        <tr id="delete<?php echo $article['id_post_article'];?>">
                                            ...
                                            <td class="art-status-<?php echo $article['id_post_article']; ?>"><?php 
                                                if($article['user_post_status'] == "draft" && $article['user_post_isdeleted'] == '0')
                                                {
                                                   $status = "Pending";
                                                }
                                                elseif($article['user_post_status'] == "publish" && $article['user_post_isdeleted'] == '0')
                                                {
                                                   $status = "Accepted";
                                                }
                                            ...
                                            <td><?php
                                                if($article['user_post_isdeleted'] == '0')
                                                {
                                                    $pub_style = "";
                                                    $rej_style = "";
                                                    if($article['user_post_status'] == "draft")
                                                    {
                                                        $pub_style = "";
                                                        $rej_style = "";
                                                    }
                                                    elseif($article['user_post_status'] == "publish")
                                                    {
                                                        $pub_style = "display: none;";
                                                        $rej_style = "";
                                                    }
                                                    elseif($article['user_post_status'] == "reject")
                                                    {
                                                        $pub_style = "";
                                                        $rej_style = "display: none;";
                                                    }
                                                    ?>
                                                    <button id="pub-art-<?php echo $article['id_post_article']; ?>" class="btn btn-primary btn-xs art-pub-<?php echo $article['id_post_article']; ?>" onclick="publish_article(<?php echo $article['id_post_article']; ?>);" title="Publish" style="<?php echo $pub_style; ?>">
                                                        <i class="fa fa-upload"></i>
                                                    </button>      
                                                    <button id="rej-art-<?php echo $article['id_post_article']; ?>" class="btn btn-danger btn-xs art-pub-<?php echo $article['id_post_article']; ?>" class="btn btn-danger btn-xs art-pub-<?php echo $article['id_post_article']; ?>" onclick="reject_article(<?php echo $article['id_post_article']; ?>);" title="Reject" style="<?php echo $rej_style; ?>">
                                                        <i class="fa fa-ban"></i>
                                                    </button>
                                                    <button id="del-art-<?php echo $article['id_post_article']; ?>" class="btn btn-danger btn-xs art-pub-<?php echo $article['id_post_article']; ?>" onclick="delete_article(<?php echo $article['id_post_article']; ?>);" title="Delete">
                                                        <i class="fa fa-trash-o"></i>
                                                    </button>
                                                <?php
                                                }?>
                                                <a class="btn btn-success btn-xs" href="<?php echo base_url('article/articledetail/'.$article['id_post_article'] ); ?>" title="View">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                        </tr><?php
