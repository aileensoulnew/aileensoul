            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">General Feedback</h3>
                        <div class="box-tools">
                           <?php echo form_open('feedback/general_search', array('method' => 'post', 'id' => 'search_frm', 'class' => 'form-inline','autocomplete' => 'off')); ?>
                           <div class="input-group input-group-sm" >
                            ...
                            { ?>
                                <a href="<?php echo base_url('feedback/clear_search_general') ?>">Clear Search</a>
                                <?php 
                            } ?>
                    ...
                    <div class="box-body table-responsive no-padding">
                      <table class="table table-hover table-bordered">
                        ...
                        if ($total_rows != 0) 
                        {
                            $i = $offset + 1; 
                            $cnt = 1;
                            foreach ($feedbackData as $_feedbackData) {
                            ?>
                            <tr id="<?php echo "feedbackdel" . $user['id']; ?>">
                                <td><?php echo $cnt; ?></td>
                                <td><?php echo $_feedbackData['feedback_email']; ?></td>
                                <td><?php echo substr($_feedbackData['feedback_desc'], 0,20);?></td>
                                <td><?php echo $_feedbackData['created_date']; ?></td>
                                <td>
                                    <a class="btn btn-success btn-xs" href="<?php echo base_url('feedback/detail/'.$_feedbackData['id'] ); ?>">
