            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                           <?php echo form_open('monetize/search', array('method' => 'post', 'id' => 'search_frm', 'class' => 'form-inline','autocomplete' => 'off')); ?>
                            <div class="input-group input-group-sm" >
                                ...
                                if ($this->session->userdata('monetize_search_keyword')){ ?>
                                    <a href="<?php echo base_url('monetize/clear_search') ?>">Clear Search</a>
                                    <?php 
                                } ?>
                            ...
                            <tbody>
                                <tr><?php
                                    ...
                                    <th>
                                        ...
                                        <a href="javascript:void(0);">Total Points</a>
                                    </th>
                                    <th>
                                        <i class="fa fa-money"></i> 
                                        <a href="javascript:void(0);">Total Earn</a>
                                    </th>
                                </tr>
                                <?php
                                if ($total_rows != 0) {
                                    ...
                                    foreach ($users as $user) { ?>
                                        <tr id="delete<?php echo $user['user_id']?>">
                                            ...
                                            <td><?php echo $user['total_point'];?></td>
                                            <td><?php echo '$'.$user['total_point'] / 100; ?></td>
                                        </tr>
                                    <?php
                                    }//for loop close
                                }//if close
