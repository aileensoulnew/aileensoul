                            ...
                            ?>
                              <tr id="delete<?php echo $_points_list['id_user_point_mapper'];?>">
                                 ...
                                 <td>
                                    ...
                                    ?>
                                    <button class="btn btn-primary btn-xs art-pub-<?php echo $_points_list['id_user_point_mapper']; ?>" onclick="approve_post_point(<?php echo $_points_list['id_user_point_mapper']; ?>);" >
                                       <i class="fa fa-check"></i>
                                    </button>                                    
                                    <button class="btn btn-danger btn-xs art-pub-<?php echo $_points_list['id_user_point_mapper']; ?>" onclick="reject_post_point(<?php echo $_points_list['id_user_point_mapper']; ?>);">
                                       <i class="fa fa-ban"></i>
                                    </button>
                                    <?php 
