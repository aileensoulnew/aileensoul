         ...
         <div class="col-xs-12">
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title">Payment Process</h3>
                  <?php /* ?>
                     ...
                     <tbody>
                        <tr>
                           ...
                           <th><i class="fa fa-fw fa-pencil-square"></i> 
                              <a href="javascript:void(0);">Threshold Date</a>
                           </th>
                           <th><i class="fa fa-fw fa-pencil-square"></i> 
                              <a href="javascript:void(0);">Payment Status</a>
                           </th>
                        ...
                        if (count($payment_list) != 0){
                           $i = $offset + 1; 
                           foreach ($payment_list as $_payment_list) {                            
                            ?>
                              <tr id="delete<?php echo $_payment_list['id_user_point_mapper'];?>">
                                 <td><?php echo $i++; ?></td>
                                 <td><?php echo ucwords($_payment_list['first_name'].' '.$_payment_list['last_name']); ?></td>
                                 <td><?php echo $_payment_list['email']; ?></td>
                                 <td><?php echo date("d M,Y", strtotime($_payment_list['modify_date'])); ?></td>
                                 <td><?php echo $_payment_list['status'];?></td>
                                 <td><?php echo $_payment_list['payment_date'] != '' ? date("d M,Y", strtotime($_payment_list['payment_date'])) : '--'; ?></td>
                                 <td>
                                    <a class="btn btn-success btn-xs" href="<?php echo base_url('monetize/monetizedetail/'.$_payment_list['id_user_payment_mapper'] ); ?>">
