...
<div class="content-wrapper">
 <!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <div class="fr">
            <a name="Add" href="<?php echo base_url('blog/add'); ?>" class="btn bg-orange btn-flat margin-r-5" >
                <i class="fa fa-fw fa-user-plus" aria-hidden="true"></i>Add Blog
            </a>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <a href="<?php echo ($this->uri->segment(3) == 'fname' && $this->uri->segment(4) == 'ASC') ? site_url($this->uri->segment(1) . '/' . $segment2 . '/fname/DESC/' . $offset) : site_url($this->uri->segment(1) . '/' . $segment2 . '/fname/ASC/' . $offset); ?>">Title</a>
                                    ...
                                    <th>
                                        <i class="fa fa-bullhorn"></i>
                                        <a href="javascript:void(0);">Related blog</a>
                                    </th>
                                    <th>
                ...
                <div class="dta_left col-md-6" id="pagination"><?php
                if ($total_rows > 0) {
...
<script language="javascript" type="text/javascript">
    ...
    function delete_blog(id){
        $("#action-modal .mes .msg").html("Are you sure want to delete this blog ?");
        $("#okbtn").attr("onclick","blog_delete("+id+")");
