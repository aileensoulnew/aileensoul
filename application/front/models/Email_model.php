...
class Email_model extends CI_Model {
    ...
    function send_email($subject = '', $templ = '', $to_email = '',$unsubscribe = '') {
        ...
        $mail->Username = $email_setting['user_name'];// 'notification@messages.aileensoul.com';// 'notification.aileensoul@gmail.com';//Amazon SES SMTP user name.        
        $mail->Password = $email_setting['password'];// 'zxzxZX912912';// 'aileensoul@123';//Amazon SES SMTP password.
        $mail->Host = $email_setting['host_name'];//'smtpdm-ap-southeast-1.aliyun.com';//'smtp.gmail.com';
    ...
    function sendEmail($app_name = '', $app_email = '', $to_email = '', $subject = '', $mail_body = '', $cc = '', $bcc = '')
    {
        ...
        $mail->Password = $email_setting['password'];//'zxzxZX912912';//Amazon SES SMTP password.
        $mail->Host = $email_setting['host_name'];//'smtpdm-ap-southeast-1.aliyun.com';// 'smtp.gmail.com';
        // $mail->setFrom('notification@messages.aileensoul.com', 'Aileensoul Notification');
        $mail->setFrom($email_setting['from_email'], ucwords($email_setting['from_name']));
        //Set an alternative reply-to address
    ...
    function send_email_template($subject = '', $email_html = '', $to_email = '',$unsubscribe = '') {
        ...
        $mail->Password = $email_setting['password'];//'zxzxZX912912';//'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'; //Amazon SES SMTP password.
    ...
    function send_email_hp($subject = '', $email_html = '', $to_email = '',$unsubscribe = '') {
        ...
        $mail->isSMTP();
        // $mail->SMTPDebug = 2;
        $mail->Username = $email_setting['user_name'];//'notification@messages.aileensoul.com';// 'pratik.aileensoul@gmail.com';// 'notification.aileensoul@gmail.com';//'apikey' //Amazon SES SMTP user name.        
        $mail->Password = $email_setting['password'];//'zxzxZX912912'; //'pratik@aileensoul';// 'aileensoul@123';//'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'; //Amazon SES SMTP password.
        $mail->Host = $email_setting['host_name'];//'smtpdm-ap-southeast-1.aliyun.com';//'smtp.gmail.com';//'smtp.sendgrid.net';// 'smtp.gmail.com';
        // $mail->setFrom('notification@messages.aileensoul.com', 'Aileensoul Notification');
        $mail->setFrom($email_setting['from_email'], ucwords($email_setting['from_name']));
        //Set an alternative reply-to address
        // $mail->addReplyTo('notification@messages.aileensoul.com', 'Aileensoul Notification');
    ...
    function send_email_ps($subject = '', $email_html = '', $to_email = '',$unsubscribe = '') {
        ...
        // $mail->SMTPDebug = 2;
        $mail->Username = $email_setting['user_name'];//'notification@messages.aileensoul.com';// 'notification.aileensoul@gmail.com';//'apikey' //Amazon SES SMTP user name.        
        $mail->Password = $email_setting['password'];//'zxzxZX912912';// 'aileensoul@123';//'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'; //Amazon SES SMTP password.
        $mail->Host = $email_setting['host_name'];//'smtpdm-ap-southeast-1.aliyun.com';//'smtp.sendgrid.net';// 'smtp.gmail.com';
        // $mail->setFrom('notification@messages.aileensoul.com', 'Aileensoul Notification');
        $mail->setFrom($email_setting['from_email'], ucwords($email_setting['from_name']));
        //Set an alternative reply-to address
        ...
        // Enable TLS encryption over port 587
        $mail->SMTPSecure = $email_setting['smtp_secure'];// 'ssl';
        $mail->Port = $email_setting['out_going_port'];//465;
        if ($_SERVER['HTTP_HOST'] == "aileensoul.localhost" || $_SERVER['HTTP_HOST'] == "staging.aileensoul.com") {
            return true;
        }
        $failed_email = explode(",", FAILED_EMAIL);
