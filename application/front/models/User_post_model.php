        ...
        else
        {
            if($new_signup == 1)
            {
                ...
                if($getUserStudentData)
                {
                    ...
                    $query = $this->db->query("CALL feed_new_signup_total_row_student($user_id)");
                    $user_post_total = $query->row_array();
            ...
            if($new_signup == 0)
            {
                if($getUserProfessionData)
                {
                    ...
                    $query = $this->db->query("CALL feed_total_row_profession($user_id)");
                    $user_post_total = $query->row_array();
                ...
                if($getUserStudentData)
                {
                    ...
                    $query = $this->db->query("CALL feed_total_row_student($user_id)");
                    $user_post_total = $query->row_array();
        ...
        else
        {
            ...
            if($new_signup == 1)
            {
                ...
                if($getUserStudentData)
                {
                    ...
                    $query = $this->db->query("CALL feed_new_signup_get_rows_student($user_id,$limit,$start,$total_record)");
            ...
            if($new_signup == 0)
            {
                if($getUserProfessionData)
                {
                    ...
                    $query = $this->db->query("CALL feed_get_rows_profession($user_id,$limit,$start,$total_record)");
                ...
                if($getUserStudentData)
                {
                    ...
                    $query = $this->db->query("CALL feed_get_rows_student($user_id,$limit,$start,$total_record)");
