...
class Business_model extends CI_Model {
    ...
    public function get_business_follower_data($user_id = '', $sortby = '', $orderby = '', $limit = '', $page = '',$login_user_id) {        
        ...
        $this->db->select("u.user_id,u.first_name,u.last_name,CONCAT(u.first_name,' ',u.last_name) as fullname,u.user_gender,ui.user_image,ui.profile_background ,jt.name as title_name,d.degree_name,u.user_slug,uf.status as follow_status,uf.follow_type")->from("user_follow  uf");
