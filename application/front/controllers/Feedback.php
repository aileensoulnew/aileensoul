...
<body>
  ...
  echo "<pre>"; print_r($email_html); die();
    ...
    public function main_feedback_insert()
    {
        ...
        {
            // email send to admin
            $toemail_admin = "dshah1341@gmail.com";
            $subject = "Aileensoul Feedback.";
            $email_html = '';
            $email_html .= '<table  width="100%" cellpadding="0" cellspacing="0" style="font-family:arial;font-size:13px;">
            <tr><td style="padding-left:20px;">Hi admin!<br><br>
            <p style="padding-left:70px;"> You have recevied a new feedback  from user while you were away..</p><br></td></tr>';
            ...
            $email_html .= '</td></tr>';             
            $email_html .= '<tr><td style="padding-bottom: 3px;padding-left:20px;">';
            $email_html .= '<b>Email-Address</b> : '. $f_email;
            $email_html .= '</td></tr>';
            $email_html .= '<tr><td style="padding-bottom: 3px;padding-left:20px;">';
            $email_html .= '<b>Message</b> : '. $f_desc;
            $email_html .= '</td></tr>';
            $email_html .= '</tr></table>';
            $send_email = $this->email_model->send_email($subject = $subject, $templ = $email_html, $to_email = $toemail_admin);
            ...
            $email_user .= '</table>';
             ...
             $send_user = $this->email_model->send_email($subject = $subject, $templ = $email_user, $to_email = $f_email);
