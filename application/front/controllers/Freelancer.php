...
class Freelancer extends MY_Controller {
    ...
    public function save_individual()
    {
        ...
        if ($insert_id) {
            ...
            $url1 = base_url()."freelancer/generate_freelancer_profile";
    ...
    public function generate_freelancer_profile()
    {
        ...
        if(isset($user_education) && !empty($user_education))
        {
            foreach ($user_education as $_user_education) {
                ...
                $this->freelancer_apply_model->set_user_education($user_id,$edu_school_college,$edu_university,$edu_other_university,$edu_degree,$edu_stream,$edu_other_degree,$edu_other_stream,$edu_start_date,$edu_end_date,$edu_nograduate,$fileName,$edit_edu = 0);
            }
        }
        ...
        if(isset($user_projects) && !empty($user_projects))
        {
            foreach ($user_projects as $_user_projects) {
                ...
                $this->freelancer_apply_model->set_user_project($user_id,$project_title,$project_team,$project_role,$project_skill_ids,$project_field,$project_other_field,$project_url,$project_partner_name,$project_start_date,$project_end_date,$project_desc,$fileName,$edit_project = 0);
            }
        }
        ...
        if(isset($user_publication) && !empty($user_publication))
        {
            foreach ($user_publication as $_user_publication) {
                ...
                $this->freelancer_apply_model->set_user_publication($user_id,$pub_title,$pub_author,$pub_url,$pub_publisher,$pub_desc,$publication_date,$fileName,$edit_publication = 0);
            }
        }
        ...
        if(isset($user_experience) && !empty($user_experience))
        {
            foreach ($user_experience as $_user_experience) {
                ...
                $this->freelancer_apply_model->set_user_experience($user_id,$exp_company_name,$exp_designation_id,$exp_company_website,$exp_field,$exp_other_field,$exp_country,$exp_state,$exp_city,$exp_start_date,$exp_end_date,$exp_isworking,$exp_desc,$fileName,$edit_exp);
            }
        }
        ...
        if(isset($user_addicourse) && !empty($user_addicourse))
        {
            foreach ($user_addicourse as $_user_addicourse) {
                ...
                $this->freelancer_apply_model->set_user_addicourse($user_id,$addicourse_name,$addicourse_org,$addicourse_start_date,$addicourse_end_date,$addicourse_url,$fileName,$edit_addicourse);
            }
        }
