...
class Search_live extends MY_Controller {
...
<button id = "' . $post_business_profile_post_id . '" onClick = "insert_comment(this.id)">Comment
    ...
    public function freelancer_hire_search($searchkeyword = "", $searchplace = "") {
        ...
        if ($this->session->userdata('aileenuser')) {
            ...
            if ($free_hire_result) {
                $this->load->view('freelancer_live/freelancer_hire/recommen_freelancer_hire', $this->data);
            } else {
                $this->load->view('freelancer_live/freelancer_hire/hire_search', $this->data);
            }
        } else {
            $this->load->view('freelancer_live/freelancer_hire/hire_search', $this->data);
        }
