...
class Business_profile extends MY_Controller {
    ...
    public function __construct() {
        ...
        $this->data['no_business_post_html'] = '<div class="art_no_post_avl"><h3>Post</h3><div class="art-img-nn"><div class="art_no_post_img"><img src=' . base_url('assets/img/bui-no.png?ver=' . time()) . ' alt="bui-no.png"></div><div class="art_no_post_text">No Post Available.</div></div></div>';
        $this->data['no_business_contact_html'] = '<div class="art-img-nn"><div class="art_no_post_img"><img src="' . base_url('assets/img/No_Contact_Request.png?ver=' . time()) . '"></div><div class="art_no_post_text">No Contacts Available.</div></div>';
            ...
            if ($user['business_user_image'] != '') {
                ...
                if (IMAGEPATHFROM == 'upload') {
                    if (!file_exists($this->config->item('bus_profile_thumb_upload_path') . $user['business_user_image'])) {
                        ...
                        $return_html .= '<img src="' . BUS_PROFILE_THUMB_UPLOAD_URL . $user['business_user_image'] . '?ver=' . time() . '" height="50px" width="50px" alt="' . $user['business_user_image'] . '" >';
                    }
                } else {
...
// insert notification
                ...
                if ($insert_id) {
                    ...
                    $unsubscribeData = $this->db->select('encrypt_key,user_slug,user_id,is_subscribe')->get_where('user', array('user_id' => $busdatatoid[0]['user_id']))->row();
                    ...
                    if ($userlist['business_user_image']) {
                        ...
                        if (IMAGEPATHFROM == 'upload') {
                            if (!file_exists($this->config->item('bus_profile_thumb_upload_path') . $userlist['business_user_image'])) {
                                ...
                                $third_user_html .= '<img src = "' . BUS_PROFILE_THUMB_UPLOAD_URL . $userlist['business_user_image'] . '?ver=' . time() . '" alt = "' . $userlist['business_user_image'] . '">';
                            }
                        } else {
...
//if user deactive profile then redirect to business_profile/index untill active profile End
                ...
                if (count($followingotherdata) == 0) {
                    $notfound = ' <div class="art-img-nn">
                                    <div class="art_no_post_img">
                                        ...
                                        <img src="' . base_url('assets/img/icon_no_following.png') . '?ver=' . time() . '" alt="icon_no_following.png">
        ...
        if (count($userlist1) > 0) {
            foreach ($userlist as $user) {
                ...
                $sql = "SELECT IF (bp.city IS NULL, concat(bp.business_slug, '-', st.state_name) ,concat(bp.business_slug, '-', ct.city_name)) as business_slug 
                        ...
                        WHERE business_profile_id = '". $user['follow_from'] ."'";
                        // echo $sql;
                $query = $this->db->query($sql);
                $followerslug = $query->row()->business_slug;
                if ($followerimage != '') {
                    ...
                    if (IMAGEPATHFROM == 'upload') {
                        if (!file_exists($this->config->item('bus_profile_thumb_upload_path') . $followerimage)) {
                            ...
                            $return_html .= '<img src="' . BUS_PROFILE_THUMB_UPLOAD_URL . $followerimage . '?ver=' . time() . '" height="50px" width="50px" alt="' . $followerimage . '" >';
                        }
                    } else {
            ...
            $return_html .= '<div class="art-img-nn" id= "art-blank">
                                                <div class="art_no_post_img">
                                                    <img src="' . base_url('assets/img/icon_no_follower.png?ver=' . time()) . '" alt="icon_no_follower.png">
                                                </div>
                                                <div class="art_no_post_text">
    ...
    public function ajax_following($id = "") {
        ...
        if ($id == $slug_id || $id == '') {
            ...
            $userlist = $this->business_model->business_following($follow_from = $businessdata1[0]['business_profile_id'], $sortby = '', $orderby = '', $limit, $offset);
            $userlist1 = $this->business_model->business_following($follow_from = $businessdata1[0]['business_profile_id']);
        } else {
        ...
        <div class = "profile-job-post-title-inside clearfix">
            <div class = "profile-job-post-location-name">
                ...
                $sql = "SELECT IF (bp.city IS NULL, concat(bp.business_slug, '-', st.state_name) ,concat(bp.business_slug, '-', ct.city_name)) as business_slug 
                        ...
                        LEFT JOIN ailee_cities ct on bp.city = ct.city_id 
                        LEFT JOIN ailee_states st on bp.state = st.state_id 
                        WHERE business_profile_id = '". $user['follow_to'] ."'";
                        // echo $sql;
                $query = $this->db->query($sql);
                $slug = $query->row()->business_slug;
                ...
                if ($this->db->get_where('business_profile', array('business_profile_id' => $user['follow_to']))->row()->business_user_image != '') {
                    ...
                    if (IMAGEPATHFROM == 'upload') {
                        if (!file_exists($this->config->item('bus_profile_thumb_upload_path') . $uimage)) {
                            ...
                            $return_html .= '<img src="' . BUS_PROFILE_THUMB_UPLOAD_URL . $this->db->get_where('business_profile', array('business_profile_id' => $user['follow_to']))->row()->business_user_image . '?ver=' . time() . '" height="50px" width="50px" alt="" >';
                        }
                    } else {
...
// busienss_profile like comment ajax start
    ...
    public function like_comment() {
        ...
        $businessprofiledata = $this->data['businessprofiledata'] = $this->business_model->getBusinessLikeComment($post_id = $_POST["post_id"]);
            ...
            if ($businessprofiledata[0]['user_id'] == $userid) {
                ...
                if ($busnotification[0]['not_read'] == 2) {
					...
					<tr>
                        ...
                        $unsubscribeData = $this->db->select('encrypt_key,user_slug,user_id,is_subscribe')->get_where('user', array('user_id' => $businessprofiledata[0]['user_id']))->row();
...
// end notification
            ...
            $updatdata = $this->common->update_data($data, 'business_profile_post_comment', 'business_profile_post_comment_id', $post_id);
            $businessprofiledata2 = $this->data['businessprofiledata2'] = $this->business_model->getBusinessLikeComment($post_id = $_POST["post_id"]);
    ...
    public function like_comment1() {
        ...
        $post_id = $_POST['post_id'];
        $bus_not_to_id = $businessprofiledata = $this->data['businessprofiledata'] = $this->business_model->getBusinessLikeComment($post_id = $post_id);
...
//Business_profile comment delete start
    public function delete_comment() {
        ...
        $updatdata = $this->common->update_data($data, 'business_profile_post_comment', 'business_profile_post_comment_id', $post_id);
        $businessprofiledata = $this->data['businessprofiledata'] = $this->business_model->getBusinessPostComment($post_id = $post_delete, $sortby = 'business_profile_post_comment_id', $orderby = 'DESC', $limit = '1');

        $buscmtcnt = $this->business_model->getBusinessPostComment($post_id = $post_delete, $sortby = 'business_profile_post_comment_id', $orderby = 'DESC', $limit = '');
        ...
        if (count($businessprofiledata) > 0) {
            foreach ($businessprofiledata as $business_profile) {
                ...
                $businesscommentlike = $this->data['businesscommentlike'] = $this->business_model->getBusinessLikeComment($post_id = $business_profile['business_profile_post_comment_id'], $sortby = '', $orderby = '', $limit = '');
                $likeuserarray = explode(',', $businesscommentlike[0]['business_comment_like_user']);
...
//second page manage in manage post for function start
    ...
    public function delete_commenttwo() {
        ...
        $updatdata = $this->common->update_data($data, 'business_profile_post_comment', 'business_profile_post_comment_id', $post_id);
        $businessprofiledata = $this->data['businessprofiledata'] = $this->business_model->getBusinessPostComment($post_id = $post_delete, $sortby = 'business_profile_post_comment_id', $orderby = 'ASC', $limit = '');
        if (count($businessprofiledata) > 0) {
            foreach ($businessprofiledata as $business_profile) {
...
// insert notification
        ...
        if ($busdatacomment[0]['user_id'] == $userid || $busdatacomment[0]['is_delete'] == '1') {
            ...
            if ($insert_id_notification) {
                ...
                $unsubscribeData = $this->db->select('encrypt_key,user_slug,user_id,is_subscribe')->get_where('user', array('user_id' => $busdatacomment[0]['user_id']))->row();
...
// end notification
        ...
        foreach ($businessprofiledata as $business_profile) {
            ...
            $sql = "SELECT IF (bp.city IS NULL, concat(bp.business_slug, '-', st.state_name) ,concat(bp.business_slug, '-', ct.city_name)) as business_slug
                    ...
                    LEFT JOIN ailee_cities ct on bp.city = ct.city_id
                    LEFT JOIN ailee_states st on bp.state = st.state_id
                    WHERE bp.status = '1' AND user_id = '". $business_profile['user_id'] ."'";
            ...
            $businesscommentlike = $this->data['businesscommentlike'] = $this->business_model->getBusinessLikeComment($post_id = $business_profile['business_profile_post_comment_id']);
...
//business_profile comment edit start
    public function edit_comment_insert() {
        ...
        $updatdata = $this->common->update_data($data, 'business_profile_post_comment', 'business_profile_post_comment_id', $post_id);
        if ($updatdata) {
            $businessprofiledata = $this->business_model->getBusinessCommentData($post_id = $_POST["post_id"], $select_data = 'comments');
...
// insert notification
        ...
        if ($buspostid[0]['user_id'] == $userid) {
            ...
            if ($insert_id_notification) {
                ...
                $unsubscribeData = $this->db->select('encrypt_key,user_slug,user_id,is_subscribe')->get_where('user', array('user_id' => $buspostid[0]['user_id']))->row();
...
// insert notification
            ...
            if ($busimglike[0]['user_id'] == $userid) {
                ...
                if ($insert_id) {
                    ...
                    $unsubscribeData = $this->db->select('encrypt_key,user_slug,user_id,is_subscribe')->get_where('user', array('user_id' => $busimglike[0]['user_id']))->row();
...
//if user deactive profile then redirect to business_profile/index untill active profile End
        ...
        if ($contactperson) {
            ...
            if ($status == 'pending') {
                ...
                $contactdata .= '<div><div class="add-contact"><div></div><div></div><div></div>
                                    <div><span class="cancel_req_busi"><img src="' . base_url('assets/img/icon_contact_add.png?ver=' . time()) . '" alt="icon_contact_add.png"></span></div>
                ...
                $contactdata .= '<div class="cance_req_main_box"><div class="add-contact"><div></div><div></div><div></div>
                    <div><span class="cancel_req_busi"><img src="' . base_url('assets/img/icon_contact_cancel.png?ver=' . time()) . '" alt="icon_contact_cancel.png"></span></div>
                ...
                if ($contactperson_to) {
                    ...
                    if ($busdata[0]['business_user_image']) {
                        if (IMAGEPATHFROM == 'upload') {
                            ...
                            $filename = $this->config->item('bus_profile_thumb_upload_path') . $busdata[0]['business_user_image'] . '?ver=' . time();
                            $this->data['info'] = $info = $s3->getObjectInfo(bucket, $filename);
                            if (!$info) {
                                $contactdata .= '<img src="' . base_url() . NOBUSIMAGE . '" alt="NOBUSIMAGE">';
                            } else {
    ...
    public function ajax_contact_list() {
        ...
        $sql_frnd_req = "SELECT cp.*, IF (bp.city IS NULL, concat(bp.business_slug, '-', s.state_name) ,concat(bp.business_slug, '-', ct.city_name)) as business_slug,
            ...
            JOIN ailee_business_profile as bp ON bp.user_id=cp.contact_from_id 
            LEFT JOIN ailee_cities ct ON ct.city_id = bp.city  
            LEFT JOIN ailee_states s ON s.state_name = bp.state 
            WHERE contact_to_id = '" . $userid ."' AND cp.status = 'pending' 
            ORDER BY contact_id DESC LIMIT " . $offset . "," . $limit;
            $req_query = $this->db->query($sql_frnd_req);
            $friendlist_req = $this->data['friendlist_req'] = $req_query->result_array();
            // print_r($friendlist_req);
            // exit;
        ...
        $sql_frnd_req1 = "SELECT cp.*, IF (bp.city IS NULL, concat(bp.business_slug, '-', s.state_name) ,concat(bp.business_slug, '-', ct.city_name)) as business_slug,
            bp.business_profile_id,bp.company_name,bp.country,bp.state,bp.city,bp.pincode,bp.address,bp.contact_person,bp.contact_mobile,bp.contact_email,bp.contact_website,bp.business_type,bp.industriyal,bp.details,bp.addmore,bp.user_id,bp.status,bp.is_deleted,bp.created_date,bp.modified_date,bp.business_step,bp.business_user_image,bp.profile_background,bp.profile_background_main,bp.other_business_type,bp.other_industrial 
            FROM ailee_contact_person cp
            JOIN ailee_business_profile as bp ON bp.user_id=cp.contact_from_id 
            LEFT JOIN ailee_cities ct ON ct.city_id = bp.city  
            ...
            $req_query1 = $this->db->query($sql_frnd_req1);
            $friendlist_req1 = $req_query1->result_array();
        // $join_str[0]['table'] = 'business_profile';
        // $join_str[0]['join_table_id'] = 'business_profile.user_id';
        // $join_str[0]['from_table_id'] = 'contact_person.contact_to_id';
        // $join_str[0]['join_type'] = '';
        ...
        $sql = "SELECT cp.*,IF (bp.city IS NULL, concat(bp.business_slug, '-', s.state_name) ,concat(bp.business_slug, '-', ct.city_name)) as business_slug,
            bp.business_profile_id,bp.company_name,bp.country,bp.state,bp.city,bp.pincode,bp.address,bp.contact_person,
            bp.contact_mobile,bp.contact_email,bp.contact_website,bp.business_type,bp.industriyal,bp.details,
            bp.addmore,bp.user_id,bp.status,bp.is_deleted,bp.created_date,bp.modified_date,bp.business_step,
            bp.business_user_image,bp.profile_background,bp.profile_background_main,bp.other_business_type,
            bp.other_industrial 
            FROM ailee_contact_person cp
            JOIN ailee_business_profile bp ON bp.user_id=cp.contact_to_id 
            LEFT JOIN ailee_cities ct ON ct.city_id = bp.city  
            LEFT JOIN ailee_states s ON s.state_name = bp.state 
            WHERE contact_from_id = '". $userid ."' AND cp.status = 'confirm' ORDER BY contact_id DESC";
        $query = $this->db->query($sql);
        $friendlist_con = $query->result_array();
    ...
    public function contact_list_approve() {
        ...
        if ($status == 1) {
            ...
            if ($updatdata) {
                ...
                $unsubscribeData = $this->db->select('encrypt_key,user_slug,user_id,is_subscribe')->get_where('user', array('user_id' => $toid))->row();
        ...
        if (count($contacts_user1) > 0) {
            foreach ($contacts_user as $user) {
                if ($user['contact_from_id'] == $business_user_id) {
                    ...
                    $sql = "SELECT company_name, industriyal, business_user_image, user_id, IF (bp.city IS NULL, concat(bp.business_slug, '-', st.state_name) ,concat(bp.business_slug, '-', ct.city_name)) as business_slug 
                        FROM ailee_business_profile bp
                        LEFT JOIN ailee_cities ct on bp.city = ct.city_id
                        LEFT JOIN ailee_states st on bp.state = st.state_id
                        WHERE user_id = '". $user['contact_to_id'] ."'";
                    ...
                    $sql = "SELECT company_name, industriyal, business_user_image, user_id,
                    IF (bp.city IS NULL, concat(bp.business_slug, '-', st.state_name) ,concat(bp.business_slug, '-', ct.city_name)) as business_slug 
                    FROM ailee_business_profile bp
                    LEFT JOIN ailee_cities ct on bp.city = ct.city_id
                    LEFT JOIN ailee_states st on bp.state = st.state_id
                    WHERE user_id = '". $user['contact_from_id'] ."'";
            ...
            <div class="user_lst">
                ...
                if (IMAGEPATHFROM == 'upload') {
                    if (!file_exists($this->config->item('bus_profile_thumb_upload_path') . $business_user_image) || $business_user_image == '') {
                        ...
                        $return_html .= '<img src="' . BUS_PROFILE_THUMB_UPLOAD_URL . $business_user_image . '?ver=' . time() . '" height="50px" width="50px" alt="' . $company_name . '" >';
                    }
                } else {
...
<a id = "' . $rowdata['business_profile_post_comment_id'] . '" onClick = "comment_editcancle(this.id)">Cancel
                        ...
                        $business_userid = $this->db->get_where('business_profile_post', array('business_profile_post_id' => $rowdata['business_profile_post_id'], 'status' => '1'))->row()->user_id;
                        if ($rowdata['user_id'] == $userid || $business_userid == $userid) {
                            $return_html .= '<span role = "presentation" aria-hidden = "true"> · </span><div class = "comment-details-menu"><input type = "hidden" name = "post_delete" id = "post_delete' . $rowdata['business_profile_post_comment_id'] . '" value = "' . $rowdata['business_profile_post_id'] . '"><a id = "' . $rowdata['business_profile_post_comment_id'] . '" onClick = "comment_delete(this.id)"> Delete<span class = "insertcomment' . $rowdata['business_profile_post_comment_id'] . '"></span></a></div>';
                        }
                        $return_html .= '<span role = "presentation" aria-hidden = "true"> · </span><div class = "comment-details-menu"><p>';

                        $return_html .= $this->common->time_elapsed_string(date('Y-m-d H:i:s', strtotime($rowdata['created_date'])));
                        $return_html .= '</br>';

                        $return_html .= '</p></div></div></div>';
                    }
                }
                $return_html .= '</div></div></div><div class = "post-design-commnet-box col-md-12"><div class = "post-design-proo-img hidden-mob">';
                $userid = $this->session->userdata('aileenuser');
                $business_userimage = $this->db->get_where('business_profile', array('user_id' => $userid, 'status' => '1'))->row()->business_user_image;
                if ($business_userimage) {
                    if (IMAGEPATHFROM == 'upload') {
                ...
                $return_html .= '</div><div id = "content" class = "col-md-12  inputtype-comment cmy_2" >
<div contenteditable = "true" class = "edt_2 editable_text" name = "' . $post_business_profile_post_id . '" id = "post_comment' . $post_business_profile_post_id . '" placeholder = "Add a Comment ..." onClick = "entercomment(' . $post_business_profile_post_id . ')" onpaste = "OnPaste_StripFormatting(this, event);"></div>
<div class="mob-comment">      
                            <button id="' . $post_business_profile_post_id . '" onClick="insert_comment(this.id)"><img src="' . base_url('assets/img/send.png') . '?ver=' . time() . '" alt="send.png">
                            </button>
...
<button id = "' . $post_business_profile_post_id . '" onClick = "insert_comment(this.id)">Comment
                    ...
                    if ($userlist['business_user_image']) {
                        ...
                        if (IMAGEPATHFROM == 'upload') {
                            if (!file_exists($this->config->item('bus_profile_thumb_upload_path') . $userlist['business_user_image'])) {
                                ...
                                $return_html .= '<img src = "' . BUS_PROFILE_THUMB_UPLOAD_URL . $userlist['business_user_image'] . '?ver=' . time() . '" alt = "' . $userlist['business_user_image'] . '">';
                            }
                        } else {
                            $filename = $this->config->item('bus_profile_thumb_upload_path') . $userlist['business_user_image'];
                            $this->data['info'] = $info = $s3->getObjectInfo(bucket, $filename);
    ...
    public function ajax_business_dashboard_post($id = '') {
        ...
        $join_str[0]['table'] = 'business_profile bp';
        $join_str[0]['join_table_id'] = 'bp.user_id';
        $join_str[0]['from_table_id'] = 'business_profile_post.user_id';
        $join_str[0]['join_type'] = '';
        $join_str[1]['table'] = 'cities ct';
        $join_str[1]['join_table_id'] = 'ct.city_id';
        $join_str[1]['from_table_id'] = 'bp.city';
        $join_str[1]['join_type'] = 'left';
        $join_str[2]['table'] = 'states st';
...
<button id = "' . $post_business_profile_post_id . '" onClick = "insert_comment(this.id)">Comment
    ...
    public function check_post_available() {
        ...
        if ($profile_data[0]['status'] == '1' && $profile_data[0]['is_delete'] == '0') {
            ...
            $user_data = $this->common->select_data_by_condition('user_login', $condition_array, $data = 'status,is_delete', $sortby = '', $orderby = '', $limit = '', $offset = '', $join_str = array(), $groupby = '');
