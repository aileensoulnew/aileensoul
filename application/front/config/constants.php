...
if ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['SERVER_ADDR'] == '127.0.0.1' || $_SERVER['HTTP_HOST'] == 'aileensoul.localhost') {
    ...
    define('PROMOTEDPOST', '15909');
    define('PROMOTEDPOSTNEW', '17658');
    error_reporting(0);
...
if (IMAGEPATHFROM == 's3bucket') {
    ...
    // USER PROFILE 80*80 IMAGE
    define('USER_PROFILE_80x80_UPLOAD_URL', BASEURL . 'uploads/user_profile/resize8/');

    // USER PROFILE 50*50 IMAGE
    define('USER_PROFILE_50x50_UPLOAD_URL', BASEURL . 'uploads/user_profile/resize5/');

    // USER PROFILE 30*30 IMAGE
    define('USER_PROFILE_30x30_UPLOAD_URL', BASEURL . 'uploads/user_profile/resize3/');
    ...
    define('ARTICLE_FEATURED_THUMBS_URL', BASEURL . 'uploads/article_featured/thumbs/');
}
