                ...
                <div class="middle-part">
                    ...
                    <div class="mob-progressbar fw">
                        ...
                        <p class="mob-edit-pro">
                            <a href="<?php echo base_url('job-profile/' . $jobdata[0]['slug']); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Profile</a>
                        </p>
                    ...
                    <div ng-if="recommended_job.length > 0" ng-repeat="job in recommended_job" ng-init="jobIndex=$index">
                        <div class="all-job-box">
                            ...
                            <div class="all-job-middle">
                                <p class="pb5">
                                    <span class="location">
                                        <span><img src="<?php echo base_url('assets/n-images/location.svg') ?>">{{job.slug_city}},({{job.country_name}})</span>
                                    </span>
                                    <span class="exp">
