            ...
            <section class="middle-main bg_white">
                <div class="container">
                    <div class="pr-pol term_desc">
						<p>This Privacy Policy applies to <a href="www.aileensoul.com">Aileensoul.com</a></p>
						...
						<ul class="policy-list">
							<li>
								...
								<b>Information Collected via Cookies</b>
								...
								<p>Users may opt out of Google personalized advertising by visiting <a href="#">Ads Settings</a></p>
								<p>To opt-out from Google Analytics cookies install an <a href="#">opt-out browser add-on.</a> </p>
								<p>To opt-out from the third party advertising visit <a href="#">optout.aboutads.info</a> and <a href="#">www.networkadvertising.org/choices</a>.</p>
								...
								<ul>
									...
									<li><a href="#">Safari (Desktop)</a></li>
									<li><a href="#">Safari (Mobile)</a></li>
									<li><a href="#">Android Browser</a></li>
							...
							<li>
								...
								<ul>
									...
									<li>
										<b>Advertising</b>
										<p>We use the information we have about you to show you personalized ads as mentioned in “Information collected via cookies” sections. </p>
									</li>
									<li>
										<b>Development</b>
