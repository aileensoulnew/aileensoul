	...
	<body class="sitemap">
		...
		<div class="middle-section">
			<div class="container mobp0">
				<div class="sitemap">
					<h1>
						<a href="<?php echo base_url().'sitemap'; ?>" target="_self">Sitemap</a>
					</h1>
					<div class="site-box">
						<h3>
						...
						<ul class="alphabet">
							...
							<li>
								<a target="_self" href="<?php echo base_url(). 'sitemap/people/'.strtolower($char);?>" <?php echo($searchword == strtolower($char) ? "class='active'" : ""); ?> target="_self"><?php echo $char; ?></a>
							</li>
							<?php endforeach; ?>
						</ul>
						<?php 
						if(isset($member_list) && empty($member_list) && $page == 0):?>
						<div class="fw pt20">
							<div>
						...
						<div class="fw pt20">
							<?php echo $links; ?>
							<h3>Aileensoul Members Starting with Letter <?php echo strtoupper($searchword); ?></h3>
						</div>
						<div class="fw pt20">
							<ul class="mid-listing">
								<?php foreach($member_list as $_member_list): ?>
								<li>
									<a href="<?php echo base_url().$_member_list['user_slug']; ?>" target="_self">
										<?php echo ucwords($_member_list['fullname']);
										if($_member_list['designaation'] != ""){?>
										<span>
											(<?php echo ucwords($_member_list['designaation']);?>)
										</span>
										<?php }
										if($_member_list['degree_name'] != ""){?>
										<span>
											(<?php echo ucwords($_member_list['degree_name']);?>)
										</span>
									<?php } ?>
									</a>
								</li>
