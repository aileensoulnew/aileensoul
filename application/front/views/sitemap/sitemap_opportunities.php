		...
		<div class="middle-section">
			<div class="container mobp0">
				<div class="sitemap">
					...
					<div class="site-box">
						<h3>
							<a href="<?php echo base_url('sitemap/opportunities'); ?>" target="_self">Opportunity Directory</a>
						</h3>
						<ul class="alphabet">
							<?php 
							foreach (range('A', 'Z') as $char): ?>
							<li>
								<a target="_self" href="<?php echo base_url(). 'sitemap/opportunities/'.strtolower($char);?>" <?php echo($searchword == strtolower($char) ? "class='active'" : ""); ?> target="_self"><?php echo $char; ?></a>
							</li>
							<?php endforeach; ?>
						</ul>
						<?php
						if(isset($opportunities_list) && empty($opportunities_list) && $page == 0):?>
						<div class="fw pt20">
							<div>
						...
						if(isset($opportunities_list) && !empty($opportunities_list)):?>
						<div class="fw pt20">
							<?php echo $links; ?>
							<h3>Opportunity Starting with Letter <?php echo strtoupper($searchword); ?></h3>
						</div>
						<div class="fw pt20">
							<ul class="mid-listing">
								<?php
								foreach($opportunities_list as $_opportunities_list):
									 ?>
								<li>
									<a href="<?php echo base_url().'o/'.$_opportunities_list['oppslug']; ?>" target="_self">
										<?php echo ucwords($_opportunities_list['opptitle'])." (".($_opportunities_list['field'] != 0 ? ucwords($_opportunities_list['field_txt']) : ($_opportunities_list['other_field'] != "" ? $_opportunities_list['other_field'] : "Other")).")";?>
									</a>
								</li>
								<?php endforeach; ?>
							</ul>
