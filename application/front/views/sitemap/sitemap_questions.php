		...
		<div class="middle-section">
			<div class="container mobp0">
				<div class="sitemap">
					...
					<div class="site-box">
						<h3>
							<a href="<?php echo base_url('sitemap/questions'); ?>" target="_self">Questions Directory</a>
						</h3>
						<ul class="alphabet">
							<?php 
							foreach (range('A', 'Z') as $char): ?>
							<li>
								<a target="_self" href="<?php echo base_url(). 'sitemap/questions/'.strtolower($char);?>" <?php echo($searchword == strtolower($char) ? "class='active'" : ""); ?> target="_self"><?php echo $char; ?></a>
							</li>
							<?php endforeach; ?>
						</ul>
						<?php
						if(isset($questions_list) && empty($questions_list) && $page == 0):?>
						<div class="fw pt20">
							<div>
						...
						<div class="fw pt20">
							<?php echo $links; ?>
							<h3>Questions Starting with Letter <?php echo strtoupper($searchword); ?></h3>
						</div>
						<div class="fw pt20">
							<ul class="mid-listing">
								<?php
								foreach($questions_list as $_questions_list):
									$url = base_url().'questions/'.$_questions_list['question_id'].'/'.$this->common->create_slug($_questions_list['question']);
									 ?>
								<li>
									<a href="<?php echo $url; ?>" target="_self">
										<?php echo ucwords($_questions_list['question']);?>
									</a>
								</li>
								<?php endforeach; ?>
							</ul>
