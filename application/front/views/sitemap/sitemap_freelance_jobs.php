		...
		<div class="middle-section">
			<div class="container mobp0">
				<div class="sitemap">
					...
					<div class="site-box">
						<h3>
							<a href="<?php echo base_url('sitemap/freelance-jobs'); ?>" target="_self">Freelance Jobs Directory</a>
						</h3>
						<ul class="alphabet">
							<?php 
							foreach (range('A', 'Z') as $char): ?>
							<li>
								<a target="_self" href="<?php echo base_url(). 'sitemap/freelance-jobs/'.strtolower($char);?>" <?php echo($searchword == strtolower($char) ? "class='active'" : ""); ?> target="_self"><?php echo $char; ?></a>
							</li>
							<?php endforeach; ?>
						</ul>
						<?php 
						if(isset($freelancer_list) && empty($freelancer_list) && $page == 0):?>
						<div class="fw pt20">
							<div>
						...
						if(isset($freelancer_list) && !empty($freelancer_list)):?>
						<div class="fw pt20">
							<?php echo $links; ?>
							<h3>Freelance Jobs Starting with Letter <?php echo strtoupper($searchword); ?></h3>
						</div>
						<div class="fw pt20">
							<ul class="mid-listing">
								<?php
								foreach($freelancer_list as $_freelancer_list):
