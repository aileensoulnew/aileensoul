		...
		<div class="middle-section">
			<div class="container mobp0">
				<div class="sitemap">
					...
					<div class="site-box">
						<h3>
							<a href="<?php echo base_url('sitemap/artist'); ?>" target="_self">Artist Directory</a>
						</h3>
						<ul class="alphabet">
							<?php 
							foreach (range('A', 'Z') as $char): ?>
							<li>
								<a target="_self" href="<?php echo base_url(). 'sitemap/artist/'.strtolower($char);?>" <?php echo($searchword == strtolower($char) ? "class='active'" : ""); ?> target="_self"><?php echo $char; ?></a>
							</li>
							<?php endforeach; ?>
						</ul>
						<?php 
						if(isset($artist_list) && empty($artist_list) && $page == 0):?>
						<div class="fw pt20">
							<div>
						...
						<div class="fw pt20">
							<?php echo $links; ?>
							<h3>Artist Profile Starting with Letter <?php echo strtoupper($searchword); ?></h3>
						</div>
						<div class="fw pt20">
							<ul class="mid-listing">
								<?php foreach($artist_list as $_artist_list): ?>
								<li>
									<a href="<?php echo base_url().'artist/p/'.$_artist_list['slug']; ?>" target="_self">
										<?php echo ucwords($_artist_list['art_fullname'])." (".$_artist_list['category_name'].")";?>
									</a>
								</li>
								<?php endforeach; ?>
							</ul>
