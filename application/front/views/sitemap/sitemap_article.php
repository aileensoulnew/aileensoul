		...
		<div class="middle-section">
			<div class="container mobp0">
				<div class="sitemap">
					...
					<div class="site-box">
						<h3>
							<a href="<?php echo base_url('sitemap/article'); ?>" target="_self">Article Directory</a>
						</h3>
						<ul class="alphabet">
							<?php 
							foreach (range('A', 'Z') as $char): ?>
							<li>
								<a target="_self" href="<?php echo base_url(). 'sitemap/article/'.strtolower($char);?>" <?php echo($searchword == strtolower($char) ? "class='active'" : ""); ?> target="_self"><?php echo $char; ?></a>
							</li>
							<?php endforeach; ?>
						</ul>
						<?php
						if(isset($article_list) && empty($article_list) && $page == 0):?>
						<div class="fw pt20">
							<div>
						...
						<div class="fw pt20">
							<?php echo $links; ?>
							<h3>Article Starting with Letter <?php echo strtoupper($searchword); ?></h3>
						</div>
						<div class="fw pt20">
							<ul class="mid-listing">
								<?php
								foreach($article_list as $_article_list):
									 ?>
								<li>
									<a href="<?php echo base_url().'article/'.$_article_list['article_slug']; ?>" target="_self">
										<?php echo ucwords($_article_list['article_title']);?>
									</a>
								</li>
								<?php endforeach; ?>
							</ul>
