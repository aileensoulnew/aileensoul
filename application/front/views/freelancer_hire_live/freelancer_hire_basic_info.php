<div class="">
    <div class="title-div">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#" ng-click="submitBasicInfoForm()">Employer Registration</a></li>
        </ul>
    </div>
                ...
                <div class="login">
                    ...
                    <form name="basicinfo" id="basicinfo" class="" ng-submit="submitBasicInfoForm()" ng-validate="basicInfoValidate">
                        <div class="form-group">
                            ...
                            <p class="student-or-not">If Student then Make your Profile <a href="<?php echo base_url(); ?>freelance-employer/educational-info">Here!</a> </p>
                        </div>
