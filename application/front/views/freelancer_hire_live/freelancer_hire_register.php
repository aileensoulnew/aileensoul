...
<html lang="en" ng-app="freelancerRegiMain" ng-controller="freelancerRegiMainController">
    ...
    <body  class="reg-form-cus">
        ...
        <div class="middle-section free-hire-reg-cus">
            <div class="container">
                <div ng-view></div>
            </div>
        ...
        <script src="<?php echo base_url('assets/js/webpage/freelancer-hire-live/freelancer_hire_regi_main.js?ver=' . time()) ?>"></script>
