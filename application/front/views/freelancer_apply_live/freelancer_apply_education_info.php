<div class="">
    <div class="title-div">
        <ul class="nav nav-tabs">
            ...
            <li><a href="#" ng-click="submitStudentInfoForm()">Freelancer Registration</a></li>
        </ul>
    </div>
                ...
                <div class="login">
                    ...
                    <form name="studentinfo" id="studentinfo"class="" ng-submit="submitStudentInfoForm()" ng-validate="studentInfoValidate">
                        ...
                        <p class="text-center submit-btn">
                            <a href="<?php echo base_url();?>freelancer/general-info" class="btn1">Back to Basic Infomation</a>
