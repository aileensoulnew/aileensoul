	...
	<ul class="dropdown-menu abc">
		<div class="all-profile-box">
			<ul class="all-pr-list">
				<li>
					<a href="<?php echo base_url("job-search"); ?>" target="_self" title="Job Profile">
				...
				<li>
					<a href="<?php echo base_url('freelance-employer'); ?>" target="_self" title="Freelance Employer">
						<div class="all-pr-img">
				...
				<li>
					<a href="<?php echo base_url('freelance-jobs'); ?>" target="_self" title="Freelancer Profile">
						<div class="all-pr-img">
