	...
	<ul class="dropdown-menu abc">
		<div class="all-profile-box">
			<ul class="all-pr-list">
				<li>
					<a href="<?php echo $this->job_profile_link; ?>" target="_self" title="Job Profile">
				...
				<li>
					<a href="<?php echo base_url('recruiter/') ?>" target="_self" title="Recruiter Profile">
						<div class="all-pr-img">
				...
				<li>
					<a href="<?php echo $freelance_hire_right_profile_link; ?>" target="_self" title="Freelance Employer">
						<div class="all-pr-img">
				...
				<li>
					<a href="<?php echo $freelance_apply_right_profile_link; ?>" target="_self" title="Freelancer Profile">
						<div class="all-pr-img">
				...
				<li>
					<a href="<?php echo base_url('business-search/') ?>" target="_self" title="Business Profile">
						<div class="all-pr-img">
				...
				<li>
					<a href="<?php echo base_url('find-artist/') ?>" target="_self" title="Artistic Profile">
						<div class="all-pr-img">
