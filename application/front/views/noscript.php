...
<html>
    <head>
        <title>No Script | Aileensoul</title>
        <?php echo $head; ?>
        <?php
        ...
        <div class="middle-section middle-section-banner new-ld-page">
            ...
            <div class="container">
                <div class="error-top-box">
                    <h1>                        
                        <span>Sorry, your browser does not support JavaScript!</span>
                        <span>To continue to use Aileensoul.com, enable javascript in your browser setting. </span>
                    </h1>                                        
                </div>
