...
<html>
	...
	<section>
      ...
      <div class="container padding-360 city-location">
      <div class="row4">
                            ...
                            <div class="title"><h1 style="font-size: 24px;text-transform: none;">Sign up First and Register in Recruiter Profile</h1></div>
                                    ...
                                    <form role="form" name="register_form" id="register_form" method="post">
                                        ...
                                        <p class="form-text">
                                            ...
                                            <a href="<?php echo base_url('terms-and-conditions'); ?>" title="Terms and Condition">Terms and Condition</a> and <a href="<?php echo base_url('privacy-policy'); ?>" title="Privacy policy">Privacy policy</a>.
                                        </p>
                                        <p>
