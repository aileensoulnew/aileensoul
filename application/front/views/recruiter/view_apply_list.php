                    ...
                    <div class="middle-part">
                        ...
                        <div class="common-form">
                            <div class="job-saved-box">
                                <h3 class="mb15">Applied candidate</h3>
                                            ...
                                            <div class="profile-job-post-title clearfix">
                                                <div class="profile-job-profile-menu">
                                                    <ul class="clearfix">
                                                        ...
                                                        if ($experiance[0]['experience_year'] != '') {
                                                            ...
                                                            <li>
                                                                ...
                                                                if ($total_work_month == '12 month' && $total_work_year == '0 year') {
                                                                    ...
                                                                    echo $year."&nbsp"."Year"."&nbsp";
                                                                    if ($total_work_month != 0) {
                                                                        echo $total_work_month."&nbsp"."Month";
                                                                    }
                                                                }
                                                                else {
                                                                    echo $total_work_year."&nbsp"."Year"."&nbsp".$total_work_month."&nbsp"."Month";
                                                                }
                                                                ?>
                                                                </span>
                                                            </li>
                                                        ...
                                                        if ($row['board_primary'] && $row['board_secondary'] && $row['board_higher_secondary'] && $graduation_data) { ?>
                                                            <li>
                                                                <b>Degree</b>
                                                                <span>
                                                                    <?php
                                                        ...
                                                        elseif ($row['board_secondary'] && $graduation_data){
                                                            ?>
                                                            <li>
                                                                <b>Degree</b>
                                                                <span>
                                                        ...
                                                        elseif($row['board_primary'] && $graduation_data) { 
                                                        ?>
                                                        <li>
                                                            <b>Degree</b>
                                                            <span>
                                                        ...
                                                        elseif($row['board_primary'] && $row['board_secondary'] && $row['board_higher_secondary']) { ?>
                                                            <li>
                                                                <b>Board of Higher Secondary</b>
                                                                <span>
                                                                    <?php echo $row['board_higher_secondary']; ?>
                                                                </span>
                                                            </li>
                                                            <li>
                                                                <b>Percentage of Higher Secondary</b>
                                                                <span>
                                                        ...
                                                        elseif($row['board_primary'] && $row['board_secondary']) { ?>
                                                            <li>
                                                                <b>Board of Secondary</b>
                                                                <span>
                                                                    <?php echo $row['board_secondary']; ?>
                                                                </span>
                                                            </li>
                                                            <li>
                                                                <b>Percentage of Secondary</b>
                                                                <span>
                                                                    <?php echo $row['percentage_secondary']; ?>
                                                                </span>
                                                            </li> <?php
                                                        }
                                                        elseif ($graduation_data) { ?>
                                                            <li>
                                                                <b>Degree</b>
                                                                <span>
                                                                    <?php
                                                        ...
                                                        elseif($row['board_primary']) { ?>
                                                            <li>
                                                                <b>Board of Primary</b>
                                                                <span>
                                                                    <?php echo $row['board_primary']; ?>
                                                                </span>
                                                            </li>
                                                            <li>
                                                                <b>Percentage of Primary</b>
                                                                <span>
                                                ...
                                                <div class="profile-job-profile-button clearfix">
                                                    <div class="apply-btn fr">
                                                        ...
                                                        if ($userid != $row['userid']) {
                                                            ...
                                                            if ($userdata) { ?>
                                                                <a href="javascript:void(0);" class="button invited" id="<?php echo 'invited' . $row['userid']; ?>" style="cursor: default;" title="Invited"> Invited</a> <?php
                                                            } else { ?>
                                                                <a  href="javascript:void(0);" class="button invite_border" id="<?php echo 'invited' . $row['userid']; ?>" onclick="inviteusermodel(<?php echo $row['userid']; ?>)" title="Invite"> Invite</a> <?php
                                                            }
                                                            if ($savedata) { ?>
