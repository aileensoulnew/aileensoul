                        ...
                        <div class="custom-user-list">
                            <div class="common-form custom-form">
                                ...
                                <div class="job-saved-box rec-edit-post post-j-c">
                                    ...
                                    ?>
                                    <?php //echo form_open(base_url('recruiter/update_post/' . $postdata[0]['post_id']), array('id' => 'editpost', 'name' => 'editpost', 'class' => 'clearfix ', 'onsubmit' => "return imgval()")); ?>
                                    <form id="editpost" name="editpost" class="clearfix form_addedit" method="post" action="<?php echo base_url('recruiter/update_post/' . $postdata[0]['post_id']); ?>" enctype="multipart/form-data" onsubmit="return imgval()">
        							...
        							<div class="job_reg_main fw post-job-cus">
        								...
        								<div class="p20 fw">
            								...
            								<div class="form-group">
                                                ...
                                                <input id="skills2" value="<?php echo $work_skill; ?>" name="skills" placeholder="Enter SKills" class="full-width " tabindex="3" size="90">
                                            ...
                                            <div class="form-group textarea-cus">
                                                ...
                                                <textarea name="interview" id="interview" tabindex="5" rows="4" cols="50" placeholder="Enter Interview Process" onfocus="var temp_value = this.value; this.value = ''; this.value = temp_value"><?php echo $postdata[0]['interview_process']; ?></textarea>
                                            ...
                                            <div class="rec_check form-group" style="margin-top: 0px;
                                                      margin-bottom: 2px;">
                                                      <?php
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="span-select">
                                                            <select id="hiring_level" name="hiring_level">
                                                                ...
                                                                <option value="1" <?php echo ($postdata[0]['hiring_level'] == '1' ? 'selected="selected"' : ''); ?> >Intern</option>
                                                                <option value="2" <?php echo ($postdata[0]['hiring_level'] == '2' ? 'selected="selected"' : ''); ?> >Entry-level</option>
                                                                <option value="3" <?php echo ($postdata[0]['hiring_level'] == '3' ? 'selected="selected"' : ''); ?> >Associate</option>
                                                                <option value="4" <?php echo ($postdata[0]['hiring_level'] == '4' ? 'selected="selected"' : ''); ?> >Mid-senior</option>
                                                                <option value="5" <?php echo ($postdata[0]['hiring_level'] == '5' ? 'selected="selected"' : ''); ?> >Director</option>
                                                                <option value="6" <?php echo ($postdata[0]['hiring_level'] == '6' ? 'selected="selected"' : ''); ?> >Executive</option>
                                                            </select>
                                                        </span>
                                                    </div>
                                                </div>
        							...
        							<div class="job_reg_main fw post-job-cus">
        								...
        								<div class="p20 fw">
                                            <div class="form-group">
                                                ...
                                                <input type="text" placeholder="Enter your company name" id="comp_name" name="comp_name" value="<?php echo $postdata[0]['comp_name']; ?>">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                    <div class="form-group">
                                                        <label>Company URL</label>
                                                        <input type="text" placeholder="Enter Company URL" id="comp_url" name="comp_url" value="<?php echo $postdata[0]['comp_url']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="span-select">
                                                            <select id="comp_schedule" name="comp_schedule">
                                                                <option value="1" <?php echo ($postdata[0]['comp_schedule'] == '1' ? 'selected="selected"' : ''); ?> >Day</option>
                                                                <option value="2" <?php echo ($postdata[0]['comp_schedule'] == '2' ? 'selected="selected"' : ''); ?> >Night</option>
                                                                <option value="3" <?php echo ($postdata[0]['comp_schedule'] == '3' ? 'selected="selected"' : ''); ?> >Flexible</option>
                                                            </select>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group textarea-cus">
                                                ...
                                                <textarea type="text" placeholder="About Company Details / Profile" id="comp_profile" name="comp_profile"><?php echo $postdata[0]['comp_profile']; ?></textarea>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="form-group uplod-file">
                                                ...
                                                <?php if($postdata[0]['comp_logo'] != ''): ?>
                                                    <img style="width:100px;" src="<?php echo REC_PROFILE_THUMB_UPLOAD_URL.$postdata[0]['comp_logo']; ?>">
                                                <?php endif; ?>
                                                <input type="hidden" id="comp_logo_old" name="comp_logo_old" value="<?php echo $postdata[0]['comp_logo']; ?>" />
                                            </div>
                                            <fieldset class="hs-submit full-width pr20 text-center">
                                                <input type="submit" title="Save" id="submit" class="btn3" tabindex="22" name="submit" value="save">
                                            </fieldset>
        								</div>
                                    </div>
                                    <?php //echo form_close(); ?>
