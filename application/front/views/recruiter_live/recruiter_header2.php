		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 mob-p0">
					<ul class="sub-menu">
						<li>
							<a href="<?php echo base_url('recruiter/home'); ?>"><i class="fa fa-home" aria-hidden="true"></i> Recruiter Profile</a>
						</li>
						<li class="dropdown">
				...
				<div class="col-sm-6 col-md-6 col-xs-6 hidden-mob">
					<div class="job-search-box1 clearfix">
						<form action="<?php echo base_url('recruiter/search'); ?>" method="get">
							...
							<fieldset class="sec_h2">
								<input id="searchplace" class="searchplace ui-autocomplete-input rec_search_loc" name="searchplace" placeholder="Find Location" autocomplete="off" type="text">
							</fieldset>
