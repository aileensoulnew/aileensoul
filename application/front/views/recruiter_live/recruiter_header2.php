...
?>
<div id="recruiter_search" class="modal fade mob-search-popup hide" role="dialog">
	...
	<div class="sub-header">
		<div class="container">
			<div class="row">
					...
					<ul class="sub-menu">
						...
						<li class="dropdown user-id">
							...
							<ul class="dropdown-menu account">
								...
								<li><a href="<?php echo base_url('recruiter/profile/') . $userid; ?>">
								...
								<li><a href="<?php echo base_url('recruiter/basic-information'); ?>">
				...
				<div class="col-sm-6 col-md-6 col-xs-6 hidden-mob hide">
...
<div class="sub-header-search hide">
	<div class="container">
