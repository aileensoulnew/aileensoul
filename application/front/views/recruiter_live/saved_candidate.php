        ...
        <section>
            ...
            <div class="container mt-22" id="paddingtop_fixed">
                <div class="row" id="row1" style="display:none;">
                    ...
                    <div class="col-md-12 cover-pic" >
                        ...
                        <button class="btn btn-success upload-result fr" onclick="myFunction()">
                            Save
                        </button>
                ...
                <div class="profile-photo">
                    ...
                    <div class="profile-pho">
                        <div class="user-pic padd_img">
                            ...
                            if ($returnpage == '') { ?>
                                <a class="cusome_upload" href="javascript:void(0);" onclick="updateprofilepopup();" title='Udate Profile Picture'><img src="<?php echo base_url(); ?>assets/img/cam.png"  alt="<?php echo "cam.png"; ?>"> Update Profile Picture</a>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="profile-main-rec-box-menu profile-box-art col-md-12 padding_les">
                        <div class=" right-side-menu art-side-menu padding_less_right right-menu-jr">
                            ...
                            <ul class="<?php echo $cls ?>">
                                ...
                                <?php if (($this->uri->segment(1) == 'recruiter') && ($this->uri->segment(2) == 'post' || $this->uri->segment(2) == 'profile' || $this->uri->segment(2) == 'add-post' || $this->uri->segment(2) == 'saved-candidate') && ($this->uri->segment(3) == $this->session->userdata('aileenuser') || $this->uri->segment(3) == '')) { ?>
                                    ...
                                    <li <?php if ($this->uri->segment(1) == 'recruiter' && $this->uri->segment(2) == 'saved-candidate') { ?> class="active" <?php } ?>><a title="Saved Candidate" href="<?php echo base_url('recruiter/saved-candidate'); ?>">Saved </a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
            ...
            <div class="container rec_res">
                <div class="job-menu-profile mob-none job_edit_menu">
                    <a href="<?php echo site_url('recruiter/profile/' . $recdata['userid']); ?>" title='<?php echo $recdata['rec_firstname'] . ' ' . $recdata['rec_lastname']; ?>'>
                        <h3><?php echo $recdata['rec_firstname'] . ' ' . $recdata['rec_lastname']; ?></h3>
                    </a>
                    <!-- text head start -->
                    <div class="profile-text" >
                        <?php
           ...
           <div class="modal-dialog modal-lm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <span class="mes">
                            <div id="popup-form">
                                <div class="fw" id="profi_loader"  style="display:none;" style="text-align:center;">
                                    <img src="<?php echo base_url('assets/images/loader.gif?ver='.time()) ?>" alt="<?php echo "loader.gif"; ?>"/>
                                </div>
                                <form id ="userimage" name ="userimage" class ="clearfix" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="col-md-7 text-center">
                                        <div id="upload-demo-one" style="display:none;" style="width:350px">
                                        </div>
                                    </div> 
