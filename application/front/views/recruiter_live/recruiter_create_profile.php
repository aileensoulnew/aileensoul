                ...
                <div class="login">
                    ...
                    <form id="recruiterinfo" name="recruiterinfo" ng-submit="submitRecruiterRegiForm()" ng-validate="recruiterRegiValidate">
                        <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="company_profile" name="company_profile" tabindex="10" placeholder="Enter Company Profile" maxlength="35" ng-model="user.company_profile"></textarea>
