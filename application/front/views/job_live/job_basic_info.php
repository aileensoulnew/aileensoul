                    ...
                    <form name="basicinfo" id="basicinfo" class="" ng-submit="submitBasicInfoForm()" ng-validate="basicInfoValidate">
                        ...
                        <div class="form-group">
                            <label for="text">What's your current position?<font color="red">*</font></label>
                                <input type="text" name="jobTitle" ng-model="user.jobTitle" ng-keyup="jobTitle()" class="form-control" placeholder="Enter job title / Designation"  id="jobTitle" typeahead="item as item.name for item in titleSearchResult | filter:$viewValue"  autocomplete="off">
