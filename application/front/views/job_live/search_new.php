                ...
                <div class="middle-part">
                    ...
                    <div class="all-job-box">
                        ...
                        <div class="all-job-top">
                            <div class="post-img">
                                <a href="<?php echo base_url(); ?>{{job.string_post_name | slugify}}-job-vacancy-in-{{job.slug_city | slugify}}-{{job.user_id}}-{{job.post_id}}" ng-if="job.comp_logo != null"><img src="<?php echo REC_PROFILE_THUMB_UPLOAD_URL ?>{{job.comp_logo}}"></a>
                            ...
                            <div class="job-top-detail">
                                ...
                                <p><a href="<?php echo base_url(); ?>{{job.string_post_name | slugify}}-job-vacancy-in-{{job.slug_city | slugify}}-{{job.user_id}}-{{job.post_id}}" ng-bind="job.rec_comp_name"></a></p>
