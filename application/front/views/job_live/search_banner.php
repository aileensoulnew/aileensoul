                    ...
                    <form onsubmit="jobsearchSubmit()" action="javascript:void(0)" method="get">
                        ...
                        <div class="pt5 fw pb20">
                            <ul class="work-timing fw">
                                <li>
                                    <label class="control control--checkbox">Full-Time
                                      <input type="checkbox" name="work_timing[]" class="work_timing-filter" value="1" />
                                      <div class="control__indicator"></div>
                                    </label>
                                </li>
                                <li>
                                    <label class="control control--checkbox">Part-Time
                                      <input class="work_timing-filter" name="work_timing[]" value="2" type="checkbox"/>
                                      <div class="control__indicator"></div>
                                    </label>
                                </li>
                                <li>
                                    <label class="control control--checkbox">Internship
                                      <input  class="work_timing-filter" name="work_timing[]" value="3" type="checkbox"/>
                                      <div class="control__indicator"></div>
                                    </label>
                                </li>
                            </ul>
                        ...
                        <div class="fw pt20">
                            <input type="submit" href="#" class="btn1" value = "Search">
                        </div>
                    </form>
                </div>
            </div>
