                            ...
                            <div id="hideuserlist" class="right_middle_side_posrt fixed_right_display animated fadeInRightBig"> 
                                ...
                                <div class="all-profile-box">
                                    ...
                                    <ul class="all-pr-list">
                                        <li>
                                            <a href="<?php echo job; ?>" title="Job Profile">
                                        ...
                                        <li>
                                            <a href="<?php echo recruiter; ?>" title="Recruiter Profile">
                                                <div class="all-pr-img">
                                        ...
                                        <li>
                                            <a href="<?php echo freelance; ?>" title="Freelance Profile">
                                                <div class="all-pr-img">
                                        ...
                                        <li>
                                            <a href="<?php echo business_profile; ?>" title="Business Profile">
                                                <div class="all-pr-img">
                                        ...
                                        <li>
                                            <a href="<?php echo find_artist; ?>" title="Artistic Profile">
                                                <div class="all-pr-img">
