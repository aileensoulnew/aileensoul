                ...
                <div class="padding_less main_art" >   <!-- Tab panes -->
                  <div class="top-tab">
                    <ul class="nav nav-tabs tabs-left remove_tab">
                      <li> <a href="<?php echo artist_photos.$get_url; ?>" title="Photos"><i class="fa fa-camera" aria-hidden="true"></i> Photos</a></li>
                      <li class="active"> <a href="<?php echo artist_videos.$get_url; ?>" title="Video"><i class="fa fa-video-camera" aria-hidden="true"></i> Video</a></li>
