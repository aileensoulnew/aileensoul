            ...
            <div class="user-midd-section">
                <div class="container mobp0">
                    ...
                    <div class="profile-box-custom left_side_posrt">                        
                        ...
                        <!-- user iamges start-->
                        <a class="fw" href="javascript:void(0);" onclick="login_profile();" title="Photos">
                        ...
                        <!-- user images end-->
                        <!-- user video start-->
                        <a class="fw" href="javascript:void(0);" onclick="login_profile();" title="Video">
                            <div class="full-box-module business_data">
                        ...
                        <!-- user audio end-->
                        <!-- user pdf  start-->
                        <a class="fw" href="javascript:void(0);" onclick="login_profile();" title="Pdf">
                            <div class="full-box-module business_data">
