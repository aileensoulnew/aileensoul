               ...
               <div class="padding_less main_art" >
                  <div class="top-tab">
                     <ul class="nav nav-tabs tabs-left remove_tab">
                        <li class="active"> <a href="<?php echo site_url('artist/' . $get_url . '/photos'); ?>" title="Photos"><i class="fa fa-camera" aria-hidden="true" title="Photos"></i>   Photos</a></li>
                        <li> <a href="<?php echo site_url('artist/' . $get_url . '/videos'); ?>" title="Video"><i class="fa fa-video-camera" aria-hidden="true"></i>  Video</a></li>
