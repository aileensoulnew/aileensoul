        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 left-header">
                    ...
                    ?>
                    <?php if (($is_userBasicInfo == '1' || $is_userStudentInfo == '1') && ($first_segment != 'business-search' && $first_segment != 'business-profile' && $isbusiness_segment === FALSE) && ($first_segment != 'artist' && $first_segment != 'find-artist' && $isartist_segment === FALSE) && ($first_segment != 'job' && $first_segment != 'job-search'  && $isjob_segment === FALSE)) { ?>
