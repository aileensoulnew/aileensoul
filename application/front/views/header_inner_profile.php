                    ...
                    <ul>
                        ...
                        <li class="dropdown user-id">
                            ...
                            <ul class="dropdown-menu profile-dropdown">
                                <li>Account</li>
                                <li><a target="_self" href="<?php echo base_url().$this->session->userdata('aileenuser_slug'); ?>" title="View Profile"><i class="fa fa-user"></i> View Profile</a></li>
			...
			<ul class="all-pr-list">
				...
				<!--li>
					<ul class="mob-footer-side"-->
                        ...
                        <li><a title="About Us" href="<?php echo base_url('about-us'); ?>"  target="_self">About</a></li>
						<li><a title="Blog" href="<?php echo base_url('blog'); ?>" target="_self">Blog</a></li>
						<li><a title="Faq" tabindex="0" href="<?php echo base_url('faq'); ?>" target="_self">FAQ</a></li>
						<li><a title="Advertise With Us" href="<?php echo base_url('advertise-with-us'); ?>" target="_self">Advertise With Us</a></li>
						<li><a title="Sitemap" tabindex="0" href="<?php echo base_url('sitemap'); ?>" target="_self">Sitemap</a></li>
						<li><a title="Report" tabindex="0" href="<?php echo base_url('report-abuse'); ?>" target="_self">Report</a></li>
						<li><a title="Contact Us" href="<?php echo base_url('contact-us'); ?>"  target="_self">Contact</a></li>
						<li><a title="Send Us Feedback" href="<?php echo base_url('feedback'); ?>" target="_self">Feedback</a></li>
						<li><a href="<?php echo base_url('terms-and-condition'); ?>" title="Terms and Condition" target="_self">Terms and Condition</a></li>
                        <li><a href="<?php echo base_url('privacy-policy'); ?>" title="Privacy policy" target="_self">Privacy Policy</a></li>
