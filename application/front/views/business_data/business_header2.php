...
<div id="business_mob_search" class="modal fade mob-search-popup" role="dialog">
    <form onsubmit="businesssearchMobileSubmit()" method="get" action="javascript:void(0)">
        <div class="new-search-input1">
        	<input id="m_tags" class="tags ui-autocomplete-input ccp_search" name="skills" placeholder="Company and Categorie" autocomplete="off" type="text">
                    ...
                    <div class="job-search-box1 clearfix">
                        <form onsubmit="businesssearchSubmit()" method="get" action="javascript:void(0)">
                            <fieldset class="sec_h2">
                                <input id="tags" class="tags ui-autocomplete-input ccp_search" name="skills" placeholder="Company and Categorie" autocomplete="off" type="text">
                            </fieldset>
                            <fieldset class="sec_h2">
