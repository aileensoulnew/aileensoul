        ...
        <div class="profile-boxProfileCard-content clearfix">
            ...
            <div class="right_left_box_design ">
                ...
                <ul class=" left_box_menubar">
                    <li
                        <?php if ($this->uri->segment(1) == 'company' && $this->uri->segment(3) == 'dashboard') { ?> class="active" 
                        <?php } ?>>
                        <a  class="padding_less_left" title="Dashboard" href="<?php echo base_url('company/' . $business_common_data[0]['business_slug']); ?>">Dashboard
                        </a>
                    </li>
                    <li 
                        <?php if ($this->uri->segment(1) == 'company' && $this->uri->segment(3) == 'followers') { ?> class="active" 
                        <?php } ?>>
