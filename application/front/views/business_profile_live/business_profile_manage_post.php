                                            ...
                                            <div class="post-discription" ng-if="post.post_data.post_for == 'opportunity'">
                                                ...
                                                <div id="post-opp-detail-{{post.post_data.id}}">
                                                    <h5 class="post-title">
                                                        ...
                                                        <p ng-if="post.opportunity_data.hashtag"><b>Hashtags:</b><span ng-bind="post.opportunity_data.hashtag" class="post-hash-tag" id="opp-recentpost-hashtag-{{post.post_data.id}}"></span></p>
