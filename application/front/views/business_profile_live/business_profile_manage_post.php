                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-sm-3 col-xs-4">
                                                        <ul class="pull-right bottom-right">
                                                            ...
                                                            <li class="post-save">
                                                                <a ng-if="user_id != post.user_data.user_id && post.post_data.post_for != 'share'" id="share-post-{{post.post_data.id}}" ng-click="share_post(post.post_data.id, $index, post)" href="javascript:void(0);" title="Share Post"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                                                            </li>
                        ...
                        <div class="share-post">
                            <div class="share-post-head">
                                <div class="post-head">
                                    <div class="post-img">
                                        <?php
                                        if ($business_login_data->business_user_image != '')
                                        { ?>
                                            <img class="login-user-pro-pic" ng-src="<?php echo BUS_PROFILE_THUMB_UPLOAD_URL . $business_login_data->business_user_image.'' ?>" alt="<?php echo $business_login_data->company_name; ?>"> 
                                        <?php
                                        }
                                        else
                                        { ?>
                                            <img class="login-user-pro-pic" ng-src="<?php echo base_url(NOBUSIMAGE) ?>">
                                    ...
                                    <div class="post-detail">
                                        <div class="fw">
                                            <a class="post-name" href="<?php echo $business_login_data->company_name; ?>"><?php echo ucwords($business_login_data->company_name); ?></a>
                                        </div>
                                        <div class="fw">                            
                                            <span class="post-designation">
                                                <?php
                                                if($business_login_data->industry_name)
                                                    echo $business_login_data->industry_name;
                                                else
                                                    echo "CURRENT WORK"; ?>
                                            </span>
                                        </div>
