...
<style>
	...
	.btn:hover{/*border:1px solid #5c5c5c; color:#5c5c5c;*/}
</style>
</head>
<body>
											...
											<table width="100%" cellpadding="0" cellspacing="0">
												<tr>
													...
													<td style="width:40%; text-align:right; padding-left:15px;">
														...
														<p style="line-height:1.5; padding-top:5px;">A new way to post your requirement in feed page itself to connect with the mass audience.</p>
													</td>
												</tr>
											</table>
										</td>
											...
											<table width="100%" cellpadding="0" cellspacing="0">
												<tr>
													...
													<td style="width:40%; text-align:left; padding-right:15px;">
														<p style="font-size:21px; font-weight:bold; font-style:italic; padding-bottom:30px;">Ask Question</p>
