                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="left-side-bar">
                                    <ul class="left-form-each">
                                        ...
                                        ?>"><a href="<?php echo base_url('freelancer/professional-information'); ?>"><?php echo $this->lang->line("professional_info"); ?></a></li>
                                        ...
                                        ?>"><a title="Portfolio" href="<?php echo base_url('freelancer/portfolio'); ?>" class="custom-none"><?php echo $this->lang->line("portfolio"); ?></a></li>
                                    </ul>
                                </div>
                            </div>
