    ...
    <div class="job-profile-left-side-bar">
        <div class="left-side-bar">
            <ul>
                ...
                <li <?php if (($this->uri->segment(1) == 'freelance-employer') && ($this->uri->segment(3) == '')) { ?> class="active" <?php } ?>><a href="<?php echo base_url('freelance-employer/'.$free_hire_login_slug); ?>">Employer Profile</a>
                </li>
