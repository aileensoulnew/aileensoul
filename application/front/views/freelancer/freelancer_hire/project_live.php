                                        ...
                                        <div class="profile-boxProfileCard-content clearfix">
                                            ...
                                            <div class="right_left_box_design ">
                                                ...
                                                <ul class=" left_box_menubar">
                                                    ...
                                                    <?php } else { ?>
                                                        <li <?php if (($this->uri->segment(1) == 'freelance-hire') && ($this->uri->segment(2) == 'employer-details')) { ?> class="active" <?php } ?>><a title="Employer Details"  class="padding_less_left" href="<?php echo base_url('freelance-employer/' . $recliveid . '?page=freelancer_post'); ?>" ><?php echo $this->lang->line("details"); ?></a></li>
                                                    <?php } ?>
                                                    <?php if ($this->session->userdata('aileenuser') == $post_user[0]['user_id']) { ?>
