                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-10 animated fadeInLeftBig">
                            ...
                            <div class="common-form custom-form">
                                ...
                                <?php echo form_open(base_url('freelancer_hire_live/freelancer_edit_post_insert/' . $freelancerpostdata[0]['post_id']), array('id' => 'postinfo', 'name' => 'postinfo', 'class' => 'clearfix form_addedit')); ?>
                                <?php
