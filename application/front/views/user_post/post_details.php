                            ...
                            <div class="all-post-top">
                                <div class="post-head">
                                    ...
                                    <div class="post-img" ng-if="post.post_data.user_type == '2' && post.post_data.post_for == 'question'">
                                        <a ng-href="<?php echo base_url() ?>company/{{post.user_data.business_slug}}" class="post-name" target="_self" ng-if="post.question_data.is_anonymously == '0'" data-toggle="popover" data-uid="{{post.user_data.user_id}}" data-utype="{{post.post_data.user_type}}">
                                    ...
                                    <div class="post-detail">
                                        <div class="fw" ng-if="post.post_data.post_for == 'question'">
                                            ...
                                            <a ng-href="<?php echo base_url() ?>{{post.user_data.user_slug}}" class="post-name" ng-bind="post.user_data.fullname" ng-if="post.post_data.user_type == '1' && post.question_data.is_anonymously == '0'" data-toggle="popover" data-uid="{{post.user_data.user_id}}" data-utype="{{post.post_data.user_type}}"></a>
                                            <a ng-href="<?php echo base_url() ?>company/{{post.user_data.business_slug}}" class="post-name" ng-bind="post.user_data.company_name" ng-if="post.post_data.user_type == '2' && post.question_data.is_anonymously == '0'" data-toggle="popover" data-uid="{{post.user_data.user_id}}" data-utype="{{post.post_data.user_type}}"></a><span class="post-time">{{post.post_data.time_string}}</span>
                                        </div>
                                                        
                                        <div class="fw" ng-if="post.post_data.post_for != 'question'">
                                            <a ng-if="post.post_data.user_type == '1'" ng-href="<?php echo base_url() ?>{{post.user_data.user_slug}}" class="post-name" ng-bind="post.user_data.fullname" data-toggle="popover" data-uid="{{post.user_data.user_id}}" data-utype="{{post.post_data.user_type}}"></a>
                                            <a ng-if="post.post_data.user_type == '2'" ng-href="<?php echo base_url() ?>company/{{post.user_data.business_slug}}" class="post-name" ng-bind="post.user_data.company_name" data-toggle="popover" data-uid="{{post.user_data.user_id}}" data-utype="{{post.post_data.user_type}}"></a><span class="post-time">{{post.post_data.time_string}}</span>
                                        </div>
                                        ...
                                        <div class="all-post-top">
                                            ...
                                            <div class="post-discription" ng-if="post.share_data.data.post_data.post_for == 'simple'">
                                                ...
                                                <p ng-if="post.share_data.data.simple_data.hashtag" class="hashtag-grd">
                                                    <b>Hashtags:</b>
                                                    <span>
                                                        <span class="post-hash-tag" id="sim-post-hashtag-{{post.share_data.data.post_data.id}}" ng-repeat="hashtag in post.share_data.data.simple_data.hashtag.split(' ')">
                                                        <a href="<?php echo base_url(); ?>hashtag/{{hashtag | removeFirstCharacter}}" target="_self">{{hashtag}}</a></span>
                                                    </span>
                                                </p>
                                                <div ng-init="limit = 250; moreShown = false">
                            ...
                            <ul>
                                <li class="like-img" ng-repeat="userlist in get_like_user_list">
                                    ...
                                    <div class="like-detail">
                                        <h4><a href="<?php echo base_url(); ?>{{userlist.user_slug}}" target="_self" data-toggle="popover" data-uid="{{userlist.user_id}}" data-utype="1">{{ userlist.user_id == '<?php echo $login_userid; ?>' ? 'You' : userlist.fullname}}</a></h4>
