        ...
        <div ng-if="people_data.length != '0'">
            <div class="search-profiles" ng-repeat="people in people_data">
                <div id="people_tooltip_content_{{$index}}" class="tooltip_templates">
                    <div class="user-tooltip">
                        <div class="tooltip-cover-img">
                            <img ng-if="people.profile_background != null && people.profile_background != ''" ng-src="<?php echo USER_BG_MAIN_UPLOAD_URL; ?>{{people.profile_background}}">                                        
                            <div ng-if="people.profile_background == null || people.profile_background == ''" class="gradient-bg" style="height: 100%"></div>
                        </div>
                        <div class="tooltip-user-detail">
                            <div class="tooltip-user-img">
                                <img ng-src="<?php echo USER_THUMB_UPLOAD_URL ?>{{people.user_image}}" ng-if="people.user_image != ''">

                                <img ng-class="people.user_id == user_id ? 'login-user-pro-pic' : ''" ng-if="people.user_image == '' && people.user_gender == 'M'" ng-src="<?php echo base_url('assets/img/man-user.jpg') ?>">

                                <img ng-class="people.user_id == user_id ? 'login-user-pro-pic' : ''" ng-if="people.user_image == '' && people.user_gender == 'F'" ng-src="<?php echo base_url('assets/img/female-user.jpg') ?>">

                            </div>

                            <h4 ng-bind="people.fullname | capitalize"></h4>
                            ...
                            <p ng-if="people.post_count != '' || people.contact_count != '' || people.follower_count != ''">
                                ...
                                <span ng-if="people.contact_count != ''"><b>{{people.contact_count}}</b> Contacts</span>
                                <span ng-if="people.follower_count != ''"><b>{{people.follower_count}}</b> Followers</span>
                            </p>

                            <ul class="" ng-if="people.mutual_friend.length > 0">
                                <li ng-if="user_id != people.user_id" ng-repeat="_friend in people.mutual_friend | limitTo:2">
                                    <div class="user-img">
                                ...
                                <li ng-if="user_id != people.user_id" class="m-contacts">
                                    <span ng-if="people.mutual_friend.length == 1">
                                        <b>{{people.mutual_friend[0].fullname}}</b> is in mutual contact.
                                    </span>
                                    <span ng-if="people.mutual_friend.length > 1">
                                        <b>{{people.mutual_friend[0].fullname}}</b>{{people.mutual_friend.length - 1 > 0 ? ' and ' : ''}}<b>{{people.mutual_friend.length - 1}}</b> more mutual contacts.
                                    </span>
                                </li>
                            </ul>
                            <div class="tooltip-btns" ng-if="user_id != people.user_id">
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo MESSAGE_URL; ?>user/{{people.user_slug}}" class="btn-new-1" target="_blank">Message</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="profile-img post-img">
                    <a href="<?php echo base_url() ?>{{people.user_slug}}" target="_self" data-toggle="popover" data-tooltip-content="#people_tooltip_content_{{$index}}">
                ...
                <div class="profile-data">
                    <p><a href="<?php echo base_url() ?>{{people.user_slug}}" ng-bind="people.fullname | capitalize" target="_self" data-toggle="popover" data-tooltip-content="#people_tooltip_content_{{$index}}"></a></p>
