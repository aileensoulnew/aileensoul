        ...
        <div class="custom-user-box no-data-available">
            <div class='art-img-nn'>
                <div class='art_no_post_img'>
                    <img src="<?php echo base_url('assets/img/no-post.png'); ?>" alt="No Opportunity">
                </div>
                <div class='art_no_post_text'>No Opportunity Available. </div>
            </div>
        </div>                                  
    </div>
</div>
                    ...
                    <ul>
                        <li class="like-img" ng-repeat="userlist in get_like_user_list">
                                        ...
                                        <div class="tooltip-btns" ng-if="user_id != userlist.user_id">
                                            <ul>
                                                <li class="contact-btn-{{userlist.user_id}}">
                                                    <a class="btn-new-1" ng-if="userlist.contact_value == 'new'" data-param="{{userlist.contact_id}}{{ today | date : 'hhmmss'}},pending,{{ userlist.user_id}}{{ today | date : 'hhmmss'}},{{$index + 1}}{{ today | date : 'hhmmss'}},0" onclick="contact(this.id);" id="contact_btn_{{userlist.user_id}}">Add to contact</a>
                                                    
                                                    <a class="btn-new-1" ng-if="userlist.contact_value == 'confirm'" data-param="{{userlist.contact_id}}{{ today | date : 'hhmmss'}},cancel,{{ userlist.user_id}}{{ today | date : 'hhmmss'}},{{$index + 1}}{{ today | date : 'hhmmss'}},1" onclick="contact(this.id);" id="contact_btn_{{userlist.user_id}}">In Contacts</a>
                                                    
                                                    <a class="btn-new-1" ng-if="userlist.contact_value == 'pending'" data-param="{{userlist.contact_id}}{{ today | date : 'hhmmss'}},cancel,{{ userlist.user_id}}{{ today | date : 'hhmmss'}},{{$index + 1}}{{ today | date : 'hhmmss'}},0" onclick="contact(this.id);" id="contact_btn_{{userlist.user_id}}">Request sent</a>
                                                    
                                                    <a class="btn-new-1" ng-if="userlist.contact_value == 'cancel'" data-param="{{userlist.contact_id}}{{ today | date : 'hhmmss'}},pending,{{ userlist.user_id}}{{ today | date : 'hhmmss'}},{{$index + 1}}{{ today | date : 'hhmmss'}},0" onclick="contact(this.id);" id="contact_btn_{{userlist.user_id}}">Add to contact</a>
                                                    
                                                    <a class="btn-new-1" ng-if="userlist.contact_value == 'reject'" data-param="{{userlist.contact_id}}{{ today | date : 'hhmmss'}},pending,{{ userlist.user_id}}{{ today | date : 'hhmmss'}},{{$index + 1}}{{ today | date : 'hhmmss'}},0" onclick="contact(this.id);" id="contact_btn_{{userlist.user_id}}">Add to contact</a>
                                                </li>
                                                <li class="follow-btn-user-{{userlist.user_id}}">
                                                    <a ng-if="userlist.follow_status == 1" class="btn-new-1 following" data-uid="{{userlist.user_id}}{{ today | date : 'hhmmss'}}" onclick="unfollow_user(this.id)" id="follow_btn_{{userlist.user_id}}">Following</a>

                                                    <a ng-if="userlist.follow_status == 0 || !userlist.follow_status" class="btn-new-1 follow" data-uid="{{userlist.user_id}}{{ today| date : 'hhmmss'}}" onclick="follow_user(this.id)" id="follow_btn_{{userlist.user_id}}">Follow</a>
                                                </li>
                                                <li>
                            ...
                            <div class="like-detail">
                                <h4><a href="<?php echo base_url(); ?>{{userlist.user_slug}}" target="_self" data-toggle="popover" data-uid="{{userlist.user_id}}" data-utype="1">{{userlist.fullname}}</a></h4>
