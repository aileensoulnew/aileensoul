                                        ...
                                        <div class="post-head">
                                            ...
                                            <div class="post-right-dropdown dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a ng-if="post.post_data.post_for != 'question' && post.post_data.post_for == 'article' && post.post_data.post_for != 'opportunity'" href="<?php echo base_url(); ?>article/{{post.article_data.article_slug}}" target="_blank">Show in new tab</a>
