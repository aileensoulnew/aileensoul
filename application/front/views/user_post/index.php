                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-3 mob-pl0">
                                <ul class="pull-right bottom-right">
                                    ...
                                    <li class="post-save">
                                        <a ng-if="live_slug != post.user_data.user_slug && post.post_data.post_for != 'share'" id="share-post-{{post.post_data.id}}" ng-click="share_post(post.post_data.id, $index, post)" href="javascript:void(0);" title="Share Post"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
                                    </li>
