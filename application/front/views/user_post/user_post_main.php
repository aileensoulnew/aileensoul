                            ...
                            <div class="tooltip-btns">
                                <ul>
                                    <li class="contact-btn-{{post.user_data.user_id}}">
                                        <a class="btn-new-1" ng-if="post.user_data.contact_value == 'new'" ng-click="contact(post.user_data.contact_id, 'pending', post.user_data.user_id,$index + 1)">Add to contact</a>
                                        <a class="btn-new-1" ng-if="post.user_data.contact_value == 'confirm'" ng-click="contact(post.user_data.contact_id, 'cancel', post.user_data.user_id,$index + 1,1)">In Contacts</a>
                                        <a class="btn-new-1" ng-if="post.user_data.contact_value == 'pending'" ng-click="contact(post.user_data.contact_id, 'cancel', post.user_data.user_id,$index + 1)">Request sent</a>
                                        <a class="btn-new-1" ng-if="post.user_data.contact_value == 'cancel'" ng-click="contact(post.user_data.contact_id, 'pending', post.user_data.user_id,$index + 1)">Add to contact</a>
                                        <a class="btn-new-1" ng-if="post.user_data.contact_value == 'reject'" ng-click="contact(post.user_data.contact_id, 'pending', post.user_data.user_id,$index + 1)">Add to contact</a>
                                    </li>
                                    <li class="follow-btn-{{post.user_data.user_id}}">
                                        <a ng-if="post.user_data.follow_status == 1" class="btn-new-1 following" ng-click="unfollow_user(post.user_data.user_id)">Following</a>
                                        <a ng-if="post.user_data.follow_status == 0 || !post.user_data.follow_status" class="btn-new-1 follow" ng-click="follow_user(post.user_data.user_id)">Follow</a>
                                    </li>
                                    <li>
                ...
                <div class="all-post-top">
                    <div class="post-head" ng-class="post.question_data.is_anonymously == '1' ? 'anonymous-que' : ''">
                        <div class="post-img" ng-if="post.post_data.user_type == '1' && post.post_data.post_for == 'question'">
                            <a ng-href="<?php echo base_url() ?>{{post.user_data.user_slug}}" class="post-name" target="_self" ng-if="post.question_data.is_anonymously == '0'" data-toggle="tooltip" data-tooltip-content="#tooltip_content_{{postIndex}}">
                        ...
                        <div class="post-img" ng-if="post.post_data.user_type == '1' && post.post_data.post_for != 'question' && post.user_data.user_image != ''">
                            <a ng-href="<?php echo base_url() ?>{{post.user_data.user_slug}}" class="post-name" target="_self" data-toggle="tooltip" data-tooltip-content="#tooltip_content_{{postIndex}}">
                        ...
                        <div class="post-img" ng-if="post.post_data.user_type == '2' && post.post_data.post_for == 'question'" data-toggle="tooltip" data-tooltip-content="#tooltip_content_{{postIndex}}">
                        ...
                        <div class="post-img" ng-if="post.post_data.user_type == '2' && post.post_data.post_for != 'question' && post.user_data.business_user_image">
                            <a ng-href="<?php echo base_url() ?>company/{{post.user_data.business_slug}}" class="post-name" target="_self" data-toggle="tooltip" data-tooltip-content="#tooltip_content_{{postIndex}}">
                        ...
                        <div class="post-detail">
                            <div class="fw" ng-if="post.post_data.post_for == 'question'">
                                ...
                                <a ng-href="<?php echo base_url() ?>{{post.user_data.user_slug}}" class="post-name" ng-bind="post.user_data.fullname" ng-if="post.post_data.user_type == '1' && post.question_data.is_anonymously == '0'" target="_self" data-toggle="tooltip" data-tooltip-content="#tooltip_content_{{postIndex}}"></a>
                                <a ng-href="<?php echo base_url() ?>company/{{post.user_data.business_slug}}" class="post-name" ng-bind="post.user_data.company_name" ng-if="post.post_data.user_type == '2' && post.question_data.is_anonymously == '0'" target="_self" data-toggle="tooltip" data-tooltip-content="#tooltip_content_{{postIndex}}"></a><span class="post-time">{{post.post_data.time_string}}</span>
                            </div>
                                            
                            <div class="fw" ng-if="post.post_data.post_for != 'question'">
                                <a ng-if="post.post_data.user_type == '1'" ng-href="<?php echo base_url() ?>{{post.user_data.user_slug}}" class="post-name" ng-bind="post.user_data.fullname" target="_self" data-toggle="tooltip" data-tooltip-content="#tooltip_content_{{postIndex}}"></a>
                                <a ng-if="post.post_data.user_type == '2'" ng-href="<?php echo base_url() ?>company/{{post.user_data.business_slug}}" class="post-name" ng-bind="post.user_data.company_name" target="_self" data-toggle="tooltip" data-tooltip-content="#tooltip_content_{{postIndex}}"></a><span class="post-time">{{post.post_data.time_string}}</span>
                            </div>
