    ...
    <div class="availabel-data-box" ng-if="searchProfileData.length != '0'">
        <div class="search-profiles" ng-repeat="searchProfile in searchProfileData">
            <div class="profile-img post-img">
                <a href="<?php echo base_url() ?>{{searchProfile.user_slug}}" target="_self" data-popover data-uid="{{searchProfile.user_id}}" data-utype="1">
            ...
            <div class="profile-data">
                <p><a href="<?php echo base_url() ?>{{searchProfile.user_slug}}" ng-bind="searchProfile.fullname | capitalize" target="_self" data-popover data-uid="{{searchProfile.user_id}}" data-utype="1"></a></p>
                    ...
                    <div class="all-post-top">
                        <div class="post-head" ng-class="post.question_data.is_anonymously == '1' ? 'anonymous-que' : ''">
                            ...
                            <div class="post-detail">
                                ...
                                <div class="fw" ng-if="post.post_data.post_for != 'question'">
                                    <a ng-if="post.post_data.user_type == '1'" ng-href="<?php echo base_url() ?>{{post.user_data.user_slug}}" class="post-name" ng-bind="post.user_data.fullname" target="_self" target="_self" data-popover data-uid="{{post.user_data.user_id}}" data-utype="{{post.post_data.user_type}}"></a>
                                    <a ng-if="post.post_data.user_type == '2'" ng-href="<?php echo base_url() ?>company/{{post.user_data.business_slug}}" class="post-name" ng-bind="post.user_data.company_name" target="_self" target="_self" data-popover data-uid="{{post.user_data.user_id}}" data-utype="{{post.post_data.user_type}}"></a><span class="post-time">{{post.post_data.time_string}}</span>
                                </div>
