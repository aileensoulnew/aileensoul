                                ...
                                <div class="post-head" ng-class="post.question_data.is_anonymously == '1' ? 'anonymous-que' : ''">
                                    ...
                                    <div class="post-img" ng-if="post.post_data.post_for != 'question' && post.user_data.user_image != ''">
                                        <a ng-href="<?php echo base_url() ?>{{post.user_data.user_slug}}" class="post-name" target="_self" data-toggle="popover" data-uid="{{post.user_data.user_id}}" data-utype="{{post.post_data.user_type}}">
                                            <img ng-src="<?php echo USER_PROFILE_50x50_UPLOAD_URL ?>{{post.user_data.user_image}}">
                                        </a>
                                    </div>
                                    ...
                                    <div class="post-detail">                                   
                                        ...
                                        <div class="fw" ng-if="post.post_data.post_for != 'question'">
                                            <a ng-href="<?php echo base_url() ?>{{post.user_data.user_slug}}" class="post-name" ng-bind="post.user_data.fullname" data-toggle="popover" data-uid="{{post.user_data.user_id}}" data-utype="{{post.post_data.user_type}}"></a><span class="post-time">{{post.post_data.time_string}}</span>
                                        </div>                                                    
                                                ...
                                                <div class="post-head">
                                                    ...
                                                    <div class="post-img" ng-if="post.share_data.data.post_data.user_type == '1' && post.share_data.data.post_data.post_for != 'question' && post.share_data.data.user_data.user_image != ''">
                                                        <a ng-href="<?php echo base_url() ?>{{post.share_data.data.user_data.user_slug}}" class="post-name" target="_self" data-toggle="popover" data-uid="{{post.share_data.data.user_data.user_id}}" data-utype="{{post.share_data.data.post_data.user_type}}">
                                                            <img ng-src="<?php echo USER_PROFILE_50x50_UPLOAD_URL ?>{{post.share_data.data.user_data.user_image}}">
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="post-img">
                                            <div ng-if="comment.user_image != ''">
                                                <a ng-href="<?php echo base_url() ?>{{comment.user_slug}}" class="post-name" target="_self" data-toggle="popover" data-uid="{{comment.commented_user_id}}" data-utype="1">
                                                    <img ng-class="comment.commented_user_id == user_id ? 'login-user-pro-pic' : ''" ng-src="<?php echo USER_PROFILE_30x30_UPLOAD_URL ?>{{comment.user_image}}">
                                                </a>
                                            </div>
                                            ...
                                            <div class="post-img">
                                                <div ng-if="commentreply.user_image != ''">
                                                    <a ng-href="<?php echo base_url() ?>{{commentreply.user_slug}}" class="post-name" target="_self" data-toggle="popover" data-uid="{{commentreply.commented_user_id}}" data-utype="1">
                                                        <img ng-class="commentreply.commented_user_id == user_id ? 'login-user-pro-pic' : ''" ng-src="<?php echo USER_PROFILE_30x30_UPLOAD_URL ?>{{commentreply.user_image}}">
                                                    </a>
                                                </div>
                                ...
                                <div class="item" id="item-{{contact.user_id}}">
                                    <div class="arti-profile-box">
                                        ...
                                        <div class="user-pr-img" ng-if="contact.user_image != ''">
                                            <a href="<?php echo base_url(); ?>{{contact.user_slug}}" >
                                                <img ng-src="<?php echo USER_PROFILE_80x80_UPLOAD_URL ?>{{contact.user_image}}">
                                            </a>
                                        </div>
                                        <div class="user-pr-img" ng-if="contact.user_image == ''">
                                            <a href="<?php echo base_url(); ?>{{contact.user_slug}}" >
            ...
            <div class="modal-content">
                ...
                <div class="mySlides mySlides2Image" ng-repeat="_postAllImageData in postAllImageData" style="display: none;">
                    ...
                    <div class="slider_img_p">
                        ...
                        <img ng-if="_postAllImageData.filetype == 'image'" ng-src="<?php echo USER_POST_MAIN_UPLOAD_URL_NEW ?>{{_postAllImageData.filename}}" alt="3Image-{{$index}}" id="element_load_{{$index + 1}}">
                    </div>
                </div>
                <?php /*else: ?>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="mySlides mySlides2{{share_post_data.post_data.id}}" ng-repeat="_photoData in share_post_data.post_file_data">
                                                ...
                                                <div class="slider_img_p">
                                                    <img ng-src="<?php echo USER_POST_MAIN_UPLOAD_URL_NEW ?>{{_photoData.filename}}" alt="5Image-{{$index}}" id="element_load_{{$index + 1}}">
                                                </div>
                                            </div>                                
                                        </div>
                                        <div class="caption-container">
