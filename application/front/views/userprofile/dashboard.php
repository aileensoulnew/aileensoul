                        ...
                        <div class="post-right-dropdown dropdown">
                            ...
                            <ul class="dropdown-menu"> 
                                ...
                                <li>
                                    ...
                                    <a ng-if="post.post_data.post_for != 'question' && post.post_data.total_post_files == '0' && (post.post_data.post_for == 'profile_update' || post.post_data.post_for == 'cover_update')" href="<?php echo base_url(); ?>{{post.user_data.user_slug}}/photo/{{post.post_data.id}}" target="_blank">Show in new tab</a>
