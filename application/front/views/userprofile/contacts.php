              ...
              <!--   <input name="page_number" class="page_number"  ng-model="page_number" ng-value="pagecntctData.pagedata.page">
                ...
                <div class="custom-user-box" ng-if="contats_data != '0'" ng-repeat="contacts in contactData">
                    ...
                    <div class="post-img" ng-if="contacts.user_image != '' && contacts.user_image != null">
                        <a href="<?php echo base_url();?>{{contacts.user_slug}}" target="_self" data-popover data-uid="{{contacts.user_id}}" data-utype="1">
                    ...
                    <div class="custom-user-detail">
                        <h4>
                            <a href="<?php echo base_url();?>{{contacts.user_slug}}" target="_self" ng-bind="(contacts.first_name | limitTo:1 | uppercase) + (contacts.first_name.substr(1) | lowercase) + ' ' + (contacts.last_name | limitTo:1 |uppercase) + (contacts.last_name.substr(1) | lowercase)" data-popover data-uid="{{contacts.user_id}}" data-utype="1"></a>
                        </h4>
