                            ...
                            <ul>
                                <li class="like-img" ng-repeat="userlist in get_like_user_list">
                                    ...
                                    <div class="like-detail">
                                        <h4><a href="<?php echo base_url(); ?>{{userlist.user_slug}}" target="_self" data-toggle="popover" data-uid="{{userlist.user_id}}" data-utype="1">{{(userlist.user_id == '<?php echo $loging_userid; ?>' ? 'You' : userlist.fullname)}}</a></h4>
