    ...
    <div class="all-detail-custom">
        <div class="custom-user-list">
            ...
            <div class="gallery" id="gallery">
				...
				<!-- 04 About User Start -->
                <div class="gallery-item">
                    <div class="dtl-box" id="about-move">
                        <div class="dtl-title">
				...
				<!-- 13 Extracurricular Activity Start -->
                <div class="gallery-item">
                    <div class="dtl-box">
                        <div class="dtl-title">
            ...
            <div class="modal-body-cus"> 
                ...
                <div class="dtl-dis dtl-about-box post-field">
                    ...
                    <div class="form-group">
                        ...
                        <tags-input id="user_fav_artist" ng-model="user_fav_artist_txt" name="user_fav_artist" display-property="fav_artist" placeholder="Enter Favourite Artist" replace-spaces-with-dashes="false" template="title-template">
                        </tags-input>
                    </div>
                    <div class="form-group">
                        ...
                        <tags-input id="user_fav_book" ng-model="user_fav_book_txt" name="user_fav_book" display-property="fav_book" placeholder="Enter Favourite Book" replace-spaces-with-dashes="false" template="title-template">
                        </tags-input>
                    </div>
                    <div class="form-group">
                        ...
                        <tags-input id="user_fav_sport" ng-model="user_fav_sport_txt" name="user_fav_sport" display-property="fav_sport" placeholder="Enter Favourite Sports" replace-spaces-with-dashes="false" template="title-template">
                        </tags-input>
                    </div>
                </div>
                <div class="dtl-btn">                        
