                ...
                <div class="list-cus fw mobp0" id="nofollowng">
                    <div class="custom-user-box" ng-if="follow_data != '0'" ng-repeat="follow in followingData">
                        ...
                        <div class="post-img" ng-if="follow.follow_type == 1 && follow.user_image != '' && follow.user_image != null">
                            <a href="<?php echo base_url();?>{{follow.user_slug}}" target="_self" data-popover data-uid="{{follow.user_id}}" data-utype="{{follow.follow_type}}">
                                <img ng-src="<?php echo USER_THUMB_UPLOAD_URL ?>{{follow.user_image}}">
                            </a>
                        </div>

                        <div class="post-img" ng-if="follow.follow_type == 2">
                            <a href="<?php echo base_url();?>company/{{follow.business_data.business_slug}}" target="_self" data-popover data-uid="{{follow.user_id}}" data-utype="{{follow.follow_type}}">
                        ...
                        <div class="custom-user-detail" ng-if="follow.follow_type == 1">
                            <h4>
                                <a href="<?php echo base_url();?>{{follow.user_slug}}"  target="_self" ng-bind="(follow.first_name | limitTo:1 | uppercase) + (follow.first_name.substr(1) | lowercase) + ' ' + (follow.last_name | limitTo:1 |uppercase) + (follow.last_name.substr(1) | lowercase)" data-popover data-uid="{{follow.user_id}}" data-utype="{{follow.follow_type}}"></a>
                            </h4>
                        ...
                        <div class="custom-user-detail" ng-if="follow.follow_type == 2">
                            <h4>
                                <a href="<?php echo base_url();?>company/{{follow.business_data.business_slug}}"  target="_self" ng-bind="(follow.business_data.company_name | limitTo:1 | uppercase) + (follow.business_data.company_name.substr(1) | lowercase)" data-popover data-uid="{{follow.user_id}}" data-utype="{{follow.follow_type}}"></a>
                            </h4>
