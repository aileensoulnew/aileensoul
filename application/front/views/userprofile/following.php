               ...
               <!--  <input name="page_number" class="page_number"  ng-model="page_number" ng-value="pagecntctData.pagedata.page">
                ...
                <div class="custom-user-box" ng-if="follow_data != '0'" ng-repeat="follow in followingData">
                        ...
                        <div class="user-tooltip" ng-if="follow.follow_type == 1">
                            ...
                            <div class="tooltip-user-detail">
                                ...
                                <p ng-if="follow.post_count != '' || follow.contact_count != '' || follow.follower_count != ''">
                                    ...
                                    <span ng-if="follow.contact_count != ''"><b>{{follow.contact_count}}</b> Connections</span>
                    ...
                    <div class="post-img" ng-if="follow.follow_type == 2">
                        <a href="<?php echo base_url();?>company/{{follow.business_data.business_slug}}" target="_self" data-toggle="popover" data-tooltip-content="#people_tooltip_content_{{$index}}">
                    ...
                    <div class="custom-user-detail" ng-if="follow.follow_type == 2">
                        <h4>
                            <a href="<?php echo base_url();?>company/{{follow.business_data.business_slug}}"  target="_self" ng-bind="(follow.business_data.company_name | limitTo:1 | uppercase) + (follow.business_data.company_name.substr(1) | lowercase)" data-toggle="popover" data-tooltip-content="#people_tooltip_content_{{$index}}"></a>
                        </h4>
