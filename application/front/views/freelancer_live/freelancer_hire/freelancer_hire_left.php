    ...
    <div class="job-profile-left-side-bar">
        <div class="left-side-bar">
            <ul>
                ...
                <li <?php if (($this->uri->segment(1) == 'freelance-hire') && ($this->uri->segment(2) == 'employer-details')) { ?> class="active" <?php } ?>><a href="<?php echo base_url('freelance-hire/employer-details/'. $free_hire_login_slug); ?>">Employer Profile</a>
                </li>
