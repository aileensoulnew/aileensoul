...
<div id="fh_mob_search" class="modal fade mob-search-popup" role="dialog">
	<form method="get">
		<div class="new-search-input">
			<input type="search" id="tags" class="tags" name="skills" value="" placeholder="Title, Keywords, or Skills" />
                    ...
                    <div class="job-search-box1 clearfix">
                        <form action="<?php echo base_url('freelance-employer/search'); ?>" method="get">
                            <fieldset class="sec_h2">
                                <input id="tags" class="tags ui-autocomplete-input skill_keyword" name="skills" placeholder="Title, Keywords, or Skills" autocomplete="off" type="text">
                            </fieldset>
                            <fieldset class="sec_h2">
