                                    ...
                                    <div class="profile-boxProfileCard  module">
                                        <div class="profile-boxProfileCard-cover"> 
                                            ...
                                            <?php if ($this->session->userdata('aileenuser') == $post_user[0]['user_id']) { ?>
                                                <a class="profile-boxProfileCard-bg u-bgUserColor a-block" href="<?php echo base_url('freelance-employer/'. $free_hire_login_slug); ?>"  aria-hidden="true" rel="noopener">
                                                   ...
                                                   <?php } else { ?>
                                                    <a class="profile-boxProfileCard-bg u-bgUserColor a-block" href="<?php echo base_url('freelance-employer/' . $recliveid . '?page=freelancer_post'); ?>" onclick="login_profile();" tabindex="-1" 
                                        ...
                                        <div class="profile-boxProfileCard-content clearfix">
                                            <div class="left_side_box_img buisness-profile-txext">
                                                <?php if ($this->session->userdata('aileenuser') == $post_user[0]['user_id']) { ?>
                                                    <a class="profile-boxProfilebuisness-avatarLink2 a-inlineBlock" href="<?php echo base_url('freelance-employer/'. $free_hire_login_slug); ?>"  title="<?php echo $freelancr_user_data[0]['fullname'] . ' ' . $freelancr_user_data[0]['username']; ?>" tabindex="-1" aria-hidden="true" rel="noopener">
                                                    <?php } else if($hire_user) { ?>
                                                        <a class="profile-boxProfilebuisness-avatarLink2 a-inlineBlock" href="javascript:void(0);"  title="<?php echo $freelancr_user_data[0]['fullname'] . ' ' . $freelancr_user_data[0]['username']; ?>" tabindex="-1" aria-hidden="true" rel="noopener">
                                                            ...
                                                            <a class="profile-boxProfilebuisness-avatarLink2 a-inlineBlock" href="<?php echo base_url('freelance-employer/' . $recliveid . '?page=freelancer_post'); ?>"  title="<?php echo $freelancr_user_data[0]['fullname'] . ' ' . $freelancr_user_data[0]['username']; ?>" tabindex="-1" aria-hidden="true" rel="noopener">
                                                       <?php  } 
                                            ...
                                            <div class="right_left_box_design ">
                                                <span class="profile-company-name ">
                                                    <?php if ($this->session->userdata('aileenuser') == $post_user[0]['user_id']) { ?>
                                                        <a href="<?php echo base_url('freelance-employer/'. $free_hire_login_slug); ?>"  title="<?php echo ucfirst(strtolower($freelancr_user_data['fullname'])) . ' ' . ucfirst(strtolower($freelancr_user_data['username'])); ?>">   <?php echo ucfirst(strtolower($freelancr_user_data[0]['fullname'])) . ' ' . ucfirst(strtolower($freelancr_user_data[0]['username'])); ?></a>
                                                    <?php } else if($hire_user) { ?>
                                                    ...
                                                    <?php } else{ ?>
                                                        <a href="<?php echo base_url('freelance-employer/' . $recliveid . '?page=freelancer_post'); ?>"  title="<?php echo ucfirst(strtolower($freelancr_user_data['fullname'])) . ' ' . ucfirst(strtolower($freelancr_user_data['username'])); ?>">   <?php echo ucfirst(strtolower($freelancr_user_data[0]['fullname'])) . ' ' . ucfirst(strtolower($freelancr_user_data[0]['username'])); ?></a>
                                                    <?php } ?>
                                                </span>
                                                ...
                                                <div class="profile-boxProfile-name">
                                                    <?php if ($this->session->userdata('aileenuser') == $post_user[0]['user_id']) { ?>
                                                        <a href="<?php echo base_url('freelance-employer/'. $free_hire_login_slug); ?>"  title="<?php echo ucfirst(strtolower($freelancr_user_data[0]['designation'])); ?>">
                                                        <?php } else if($hire_user) { ?>
                                                            <a href="javascript:void(0);"  title="<?php echo ucfirst(strtolower($freelancr_user_data[0]['designation'])); ?>">
                                                            <?php } else{ ?>
                                                                <a href="<?php echo base_url('freelance-employer/' . $recliveid . '?page=freelancer_post'); ?>"  title="<?php echo ucfirst(strtolower($freelancr_user_data[0]['designation'])); ?>">
                                                            <?php } ?>
                                                            <?php
                                                ...
                                                <ul class=" left_box_menubar">
                                                    ...
                                                    <?php } else if($hire_user) { ?>
                                                        <li <?php if (($this->uri->segment(1) == '') && ($this->uri->segment(3) == '')) { ?> class="active" <?php } ?>><a title="Employer Details"  class="padding_less_left" href="javascript:void(0);" ><?php echo $this->lang->line("details"); ?></a></li>
                                                    <?php } else { ?>
                                                        <li <?php if (($this->uri->segment(1) == 'freelance-employer') && ($this->uri->segment(3) == '')) { ?> class="active" <?php } ?>><a title="Employer Details"  class="padding_less_left" href="<?php echo base_url('freelance-employer/' . $recliveid . '?page=freelancer_post'); ?>" ><?php echo $this->lang->line("details"); ?></a></li>
                                                    <?php } ?>
                                                    <?php if ($this->session->userdata('aileenuser') == $post_user[0]['user_id']) { ?>
                                                    ...
                                                    <?php } else{ ?>
                                                        <li><a title="Projects" href="<?php echo base_url('freelance-employer/projects/' . $recliveid . '?page=freelancer_post'); ?>"><?php echo $this->lang->line("Projects"); ?></a></li>
                                                    <?php }?>
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                if ($postuser[0]['user_id'] == $this->session->userdata('aileenuser')) {
                                                                                    ?>
                                                                                    <a class="display_inline" title="<?php echo ucwords($firstname); ?>&nbsp;<?php echo ucwords($lastname); ?>" href="<?php echo base_url('freelance-employer/' . $post['user_id']); ?>"><?php echo ucwords($firstname); ?>&nbsp;<?php echo ucwords($lastname); ?>
                                                                                    </a>
                                                                                ...
                                                                                <?php } else if ($hireuser) {
                                                                                    ...
                                                                                    <?php } ?>
                                                                                <?php } else { ?>
                                                                                    <a class="display_inline" title="<?php echo ucwords($firstname); ?>&nbsp;<?php echo ucwords($lastname); ?>" href="<?php echo base_url('freelance-employer/' . $post['user_id'] . '?page=freelancer_post'); ?>"><?php echo ucwords($firstname); ?>&nbsp;<?php echo ucwords($lastname); ?>
                                                                                    </a> 
                                                                                    <?php if ($cityname || $countryname) { ?>
                                                                                        <div class="fr lction display_inline">
