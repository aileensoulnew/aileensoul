                ...
                <div class="fw text-center">
                    <ul class="footer-ul">
                        ...
                        if (!$this->session->userdata('aileenuser')) {
                            ?>
                            <li><a title="Login" href="<?php echo base_url('login'); ?>">Login</a></li>
                            <li><a title="Create an Account" href="<?php echo base_url('registration'); ?>">Sign Up</a></li>
                            <?php
                        }
                        ?>
                        <li><a title="Job Profile" href="<?php echo $job_right_profile_link; ?>">Job Profile</a></li>
                        <li><a title="Recruiter Profile" href="<?php echo $recruiter_right_profile_link; ?>">Recruiter Profile</a></li>
						<li><a title="Freelance Employer" href="<?php echo $freelance_hire_right_profile_link; ?>">Freelance Employer Profile</a></li>
                        <li><a title="Freelance Hire" href="<?php echo $freelance_apply_right_profile_link; ?>">Freelancer Profile</a></li>
                        ...
                        <li><a title="Business Profile" href="<?php echo $business_right_profile_link; ?>">Business Profile</a></li>
                        <li><a title="Artistic Profile" href="<?php echo $artist_right_profile_link; ?>">Artistic Profile</a></li>
