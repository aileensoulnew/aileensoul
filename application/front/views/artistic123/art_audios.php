      ...
      <div  class="col-sm-12 border_tag padding_low_data padding_les" >
                    ...
                    <div class="top-tab">
                      <ul class="nav nav-tabs tabs-left remove_tab">
                          ...
                          <li class="active"><a href="<?php echo base_url('artistic/audios/'.$artisticdata[0]['slug']) ?>"><i class="fa fa-music" aria-hidden="true"></i>  Audio</a></li>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/webpage/artistic/audios.js?ver='.time()); ?>"></script>
</body>
</html>