...
function register_profile() {
    //$('#login').modal('hide');
    //$('#register').modal('show');
    $('.biderror .mes').html("<div class='pop_content pop-content-cus'><h2><h2>Never miss out any opportunities, news, and updates</h2>Join Now! <p class='poppup-btns'><a class='btn1' href='"+base_url+"login'>Login</a> or <a class='btn1' href='"+base_url+"job-profile/create-account'>Register</a></p></div>");
    $('#bidmodal').modal('show');
}
